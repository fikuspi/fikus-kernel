 ...
 *  Copyright (c) 2000-2001 D Jeff Dionne <jeff@uCfikus.org>
 *  Copyright (c) 2002      Greg Ungerer <gerg@snapgear.com>
 *  Copyright (c) 2007-2010 Paul Mundt <lethal@fikus-sh.org>
 */
 ...
 * that can be used to drive ballooning decisions when Fikus is hosted
...
/*
 * handle mapping creation for uCfikus
 */
