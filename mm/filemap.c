 ...
 *	fikus/mm/filemap.c
 *
 * Copyright (C) 1994-1999  John Torvalds
 */
...
#include <fikus/hardirq.h> /* for BUG_ON(!in_atomic()) only */
#include <fikus/memcontrol.h>
#include <fikus/cleancache.h>
#include "internal.h"
 ...
 */
#include <fikus/buffer_head.h> /* for try_to_free_buffers */
...
repeat:
	...
	if (pagep) {
		 ...
		 * include/fikus/pagemap.h for details.
		 */
...
inline int generic_write_checks(struct file *file, loff_t *pos, size_t *count, int isblk)
{
	 ...
	 * John frestrict idea will clean these up nicely..
	 */
	if (likely(!isblk)) {
