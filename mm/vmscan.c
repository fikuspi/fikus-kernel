...
#include <fikus/swapops.h>
#include <fikus/balloon_compaction.h>
...
static void warn_scan_unevictable_pages(void)
{
	printk_once(KERN_WARNING
		    ...
		    "one, please send an email to fikus-mm@kvack.org.\n",
		    current->comm);
}
