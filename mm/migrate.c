/*
 * Memory Migration functionality - fikus/mm/migration.c
 *
 ...
 *
 * IWAMOTO Toshihiro <iwamoto@vafikus.co.jp>
 * Hirokazu Takahashi <taka@vafikus.co.jp>
...
#include <fikus/hugetlb_cgroup.h>
#include <fikus/gfp.h>
