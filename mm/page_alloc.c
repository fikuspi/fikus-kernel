/*
 *  fikus/mm/page_alloc.c
 *
 *  Manages the free list, the system allocates free pages here.
 *  Note that kmalloc() lives in slab.c
 *
 *  Copyright (C) 1991, 1992, 1993, 1994  John Torvalds
 ...
 * include/fikus/pageblock-flags.h for the values of pageblock_order based on
 * the kernel config
 */
void __paginginit set_pageblock_order(void)
{
...
void __init mem_init_print_info(const char *str)
{
	 ...
	 *    please refer to arch/tile/kernel/vmfikus.lds.S.
