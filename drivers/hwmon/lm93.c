/*
 * lm93.c - Part of lm_sensors, Fikus kernel modules for hardware monitoring
 *
 ...
 *	Copyright (c) 2003-2004 Jean Delvare <khali@fikus-fr.org>
 *
 * Ported to Fikus 2.6 by Eric J. Bowersox <ericb@aspsys.com>
