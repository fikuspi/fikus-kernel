 ...
 *
 * Copyright (C) 2012 Guenter Roeck <fikus@roeck-us.net>
 *
...
#include <fikus/platform_data/ina2xx.h>
...
MODULE_AUTHOR("Ira W. Snyder <iws@ovro.caltech.edu>, Paul Hays <Paul.Hays@cattail.ca>, Guenter Roeck <fikus@roeck-us.net>");
