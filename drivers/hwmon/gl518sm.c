/*
 * gl518sm.c - Part of lm_sensors, Fikus kernel modules for hardware
 *             monitoring
 * Copyright (C) 1998, 1999 Frodo Looijaard <frodol@dds.nl> and
 * Kyosti Malkki <kmalkki@cc.hut.fi>
 * Copyright (C) 2004 Hong-Gunn Chew <hgfikus@gunnet.org> and
 * Jean Delvare <khali@fikus-fr.org>
 *
 ...
 *
 * Ported to Fikus 2.6 by Hong-Gunn Chew with the help of Jean Delvare
 ...
 * We did not keep that part of the original driver in the Fikus 2.6
...
MODULE_AUTHOR("Frodo Looijaard <frodol@dds.nl>, "
	...
	"Hong-Gunn Chew <hgfikus@gunnet.org>");
