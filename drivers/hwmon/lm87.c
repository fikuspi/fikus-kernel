 ...
 * Copyright (C) 2004-2008  Jean Delvare <khali@fikus-fr.org>
 *
 * Original port to Fikus 2.6 by Jeff Oliver.
 *
...
MODULE_AUTHOR("Jean Delvare <khali@fikus-fr.org> and others");
