/*
 *  w83795.c - Fikus kernel driver for hardware monitoring
 *  Copyright (C) 2008 Nuvoton Technology Corp.
 *                Wei Song
 *  Copyright (C) 2010 Jean Delvare <khali@fikus-fr.org>
 *
...
MODULE_AUTHOR("Wei Song, Jean Delvare <khali@fikus-fr.org>");
