/*
 * w83l785ts.c - Part of lm_sensors, Fikus kernel modules for hardware
 *               monitoring
 * Copyright (C) 2003-2009  Jean Delvare <khali@fikus-fr.org>
 *
 ...
 *
 * Ported to Fikus 2.6 by Wolfgang Ziegler <nuppla@gmx.at> and Jean Delvare
 * <khali@fikus-fr.org>.
 *
...
MODULE_AUTHOR("Jean Delvare <khali@fikus-fr.org>");
