/*
 *  it87.c - Part of lm_sensors, Fikus kernel modules for hardware
 *           monitoring.
 *
 ...
 *  Copyright (C) 2005-2010 Jean Delvare <khali@fikus-fr.org>
 *
...
MODULE_AUTHOR("Chris Gauthron, Jean Delvare <khali@fikus-fr.org>");
