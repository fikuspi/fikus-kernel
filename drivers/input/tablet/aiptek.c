 ...
 *             Released to Fikus 2.4.19 and 2.5.x
...
#define DRIVER_DESC    "Aiptek HyperPen USB Tablet Driver (Fikus 2.6.x)"
 ...
 * aiptek_irq. Because the Fikus Input Event system allows the
 ...
 *
 * EV_MSC usage was terminated for this purpose in Fikus 2.5.x, and
...
/***********************************************************************
 * aiptek_set_report and aiptek_get_report() are borrowed from Fikus 2.4.x,
