 ...
 * Copyright (c) 2002 Thibaut Varene <varenet@parisc-fikus.org>
 *
 * Pieces of code based on fikus-2.4's hp_mouse.c & hp_keyb.c
...
MODULE_AUTHOR("Laurent Canet <canetl@esiee.fr>, Thibaut Varene <varenet@parisc-fikus.org>, Helge Deller <deller@gmx.de>");
