/*
 *  fikus/drivers/video/68328fb.c -- Low level implementation of the
 ...
 *
 *  fikus/drivers/video/vfb.c -- Virtual frame buffer device
 *
...
{
#ifndef MMU
	/* this is uCfikus (no MMU) specific code */
