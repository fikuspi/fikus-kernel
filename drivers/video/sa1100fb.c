/*
 *  fikus/drivers/video/sa1100fb.c
 *
 ...
 * email address:
 *
 *	fikus-arm-kernel@lists.arm.fikus.org.uk
 *
 * Clean patches should be sent to the ARM Fikus Patch System.  Please see the
 * following web page for more information:
 *
 *	http://www.arm.fikus.org.uk/developer/patches/info.shtml
 *
 * Thank you.
 *
 * Known problems:
 ...
 *	- Added PM callback
 *
 * 2001/05/26: <rmk@arm.fikus.org.uk>
 ...
 *
 * 2001/05/28: <rmk@arm.fikus.org.uk>
 ...
 *
 * 2001/06/14: <rmk@arm.fikus.org.uk>
 ...
 *
 * 2001/07/02: <rmk@arm.fikus.org.uk>
 ...
 *
 * 2001/07/23: <rmk@arm.fikus.org.uk>
 ...
 *	  support it.
 *
 * 2001/07/27: <rmk@arm.fikus.org.uk>
 *	- Halve YRES on dual scan LCDs.
 *
 * 2001/08/22: <rmk@arm.fikus.org.uk>
 *	- Add b/w iPAQ pixclock value.
 *
 * 2001/10/12: <rmk@arm.fikus.org.uk>
