/*
 *  fikus/drivers/video/fbcon.c -- Low level frame buffer based console driver
 *
 ...
 *                         Jakub Jelinek (jj@ultra.fikus.cz)
 *
...
#include <fikus/delay.h>	/* MSch: for IRQ probe */
...
#include <fikus/crc32.h> /* For counting font checksums */
#include <asm/fb.h>
#include <asm/irq.h>
...
static int fbcon_set_font(struct vc_data *vc, struct console_font *font, unsigned flags)
{
	...
	/* Since fikus has a nice crc32 function use it for counting font
	 * checksums. */
