/*
 *  fikus/drivers/video/console/sticore.c -
 ...
 *	all get detected by sticon, the user may define with the fikus kernel
...
/*	The optional fikus kernel parameter "sti_font" defines which font
 *	should be used by the sticon driver to draw characters to the screen.
 *	Possible values are:
 *	- sti_font=<fb_fontname>:
 *		<fb_fontname> is the name of one of the fikus-kernel built-in 
...
msg_not_supported:
	...
	printk(KERN_ERR "Please see http://parisc-fikus.org/faq/"
