...
/*
   rbd.c -- Export ceph rados objects as a Fikus block device
 ...
 * number of contexts in Fikus (blk, bio, genhd), but the default is
 ...
 * that comprises the image request, and the Fikus request pointer
 * (if there is one).
 */
