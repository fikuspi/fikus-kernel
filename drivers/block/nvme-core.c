...
static int nvme_process_cq(struct nvme_queue *nvmeq)
{
	 ...
	 * the queue twice and mistakenly return IRQ_NONE.  Fikus only
...
/*
 * Returns 0 on success.  If the result is negative, it's a Fikus error code;
...
MODULE_AUTHOR("Matthew Wilcox <willy@fikus.intel.com>");
MODULE_LICENSE("GPL");
MODULE_VERSION("0.8");
