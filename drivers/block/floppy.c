 ...
 * by entropy@wintermute.wpi.edu (Lawrence Foard). John.
 */
...
/*
 * 1993/4/29 -- John -- cleaned up the timer handling in the kernel, and
...
#include <fikus/mc146818rtc.h>	/* CMOS defines */
...
#include <fikus/cdrom.h>	/* for the compatibility eject ioctl */
