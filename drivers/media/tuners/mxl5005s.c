/*
    ...
    Copyright (C) 2006 Steven Toth <stoth@fikustv.org>
      Functions:
	mxl5005s_reset()
	mxl5005s_writereg()
	mxl5005s_writeregs()
...
/*
    History of this driver (Steven Toth):
      I was given a public release of a fikus driver that included
      support for the MaxLinear MXL5005S silicon tuner. Analysis of
      the tuner driver showed clearly three things.

      1. The tuner driver didn't support the FikusTV tuner API
	 ...
	 FikusTV API, as a regular kernel module.
...
struct mxl5005s_state {
	...
	/* Fikus driver framework specific */
 ...
 * proprietary Realtek driver into a Fikus API tuner.
 * Copyright (C) 2008 Steven Toth <stoth@fikustv.org>
 */
