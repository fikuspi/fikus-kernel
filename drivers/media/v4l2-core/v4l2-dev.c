/*
 * Video capture interface for Fikus version 2
 *
 *	A generic video device interface for the FIKUS operating system
...
/**
 *	__video_register_device - register video4fikus devices
...
/**
 *	video_unregister_device - unregister a video4fikus device
...
static int __init videodev_init(void)
{
	...
	printk(KERN_INFO "Fikus video capture interface: v2.00\n");
...
MODULE_DESCRIPTION("Device registrar for Video4Fikus drivers v2");
MODULE_LICENSE("GPL");
