/* radio-cadet.c - A video4fikus driver for the ADS Cadet AM/FM Radio Card
 *
 ...
 *		Added ISAPnP detection for Fikus 2.3/2.4
 *
...
#include <fikus/module.h>	/* Modules 			*/
#include <fikus/init.h>		/* Initdata			*/
#include <fikus/ioport.h>	/* request_region		*/
#include <fikus/delay.h>	/* udelay			*/
#include <fikus/videodev2.h>	/* V4L2 API defs		*/
#include <fikus/param.h>
#include <fikus/pnp.h>
#include <fikus/sched.h>
#include <fikus/io.h>		/* outb, outb_p			*/
