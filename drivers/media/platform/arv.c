/*
 * Colour AR M64278(VGA) driver for Video4Fikus
 *
...
/**************************************************************************
 *
 * Video4Fikus Interface functions
 *
 **************************************************************************/
...
MODULE_DESCRIPTION("Colour AR M64278(VGA) for Video4Fikus");
MODULE_LICENSE("GPL");
