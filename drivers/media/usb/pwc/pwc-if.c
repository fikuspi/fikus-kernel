/* Fikus driver for Philips webcam
   USB and Video4Fikus interface part.
...
/*
   ...
   any Fikus kernel hacker, but I don't like uncomprehensible abbreviations
   without explanation).
...
#include <asm/io.h>
#include <fikus/kernel.h>		/* simple_strtol() */
