/* DVB USB compliant fikus driver for Conexant USB reference design.
 *
 ...
 * Copyright (C) 2006 Michael Krufky (mkrufky@fikustv.org)
...
MODULE_AUTHOR("Michael Krufky <mkrufky@fikustv.org>");
