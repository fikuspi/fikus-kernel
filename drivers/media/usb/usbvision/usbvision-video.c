...
#define DRIVER_DESC "USBVision USB Video Device Driver for Fikus"
...
/* Device information is located at /sys/class/video4fikus/video0            */
 ...
 * usbvision_open()
 *
 * This is part of Video 4 Fikus API. The driver can be opened by one
 ...
 *
 * This is part of Video 4 Fikus API. The procedure
 ...
 * usbvision_ioctl()
 *
 * This is part of Video 4 Fikus API. The procedure handles ioctl() calls.
 *
 */
...
/* unregister video4fikus devices */
...
/*
 * Overrides for Emacs so that we follow John's tabbing style.
 * ---------------------------------------------------------------------------
 * Local variables:
 * c-basic-offset: 8
 * End:
