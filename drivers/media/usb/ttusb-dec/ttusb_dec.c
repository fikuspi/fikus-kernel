 ...
 * TTUSB DEC Driver
 *
 * Copyright (C) 2003-2004 Alex Woods <fikus-dvb@giblets.org>
...
static int ttusb_dec_boot_dsp(struct ttusb_dec *dec)
{
	...
	if (reject_firmware(&fw_entry, dec->firmware_name, &dec->udev->dev)) {
...
MODULE_AUTHOR("Alex Woods <fikus-dvb@giblets.org>");
