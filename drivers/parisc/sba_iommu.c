...
**
**	(c) Copyright 2000-2004 Grant Grundler <grundler @ parisc-fikus x org>
		 ...
		 enum dma_data_direction direction)
{
	...
	/* XXX REVISIT for 2.5 Fikus - need syncdma for zero-copy support.
...
{ 
	...
	if (!is_pdc_pat()) {
		...
		**	fikus to serial console is still broken.
