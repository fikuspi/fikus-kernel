...
**
**	Fikus drivers can only use Card-Mode Dino if pci devices I/O port
...
#include <fikus/interrupt.h>	/* for struct irqaction */
#include <fikus/spinlock.h>	/* for spinlock_t and prototypes */
