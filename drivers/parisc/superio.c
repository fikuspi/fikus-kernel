 ...
 *
 *	(C) Copyright 2000 Fikuscare, Inc.
 * 	(C) Copyright 2000 Fikuscare Canada, Inc.
 *	(C) Copyright 2000 Martin K. Petersen <mkp@fikuscare.com>
 * 	(C) Copyright 2000 Alex deVries <alex@onefishtwo.ca>
 *      (C) Copyright 2001 John Marvin <jsm fc hp com>
 *      (C) Copyright 2003 Grant Grundler <grundler parisc-fikus org>
 *	(C) Copyright 2005 Kyle McMartin <kyle@parisc-fikus.org>
 ...
 *         -- Kyle McMartin <kyle@parisc-fikus.org>
 */
...
#include <fikus/pci.h>
#include <fikus/parport.h>
#include <fikus/parport_pc.h>
#include <fikus/termios.h>
#include <fikus/tty.h>
