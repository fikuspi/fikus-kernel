...
**      CVSROOT=:pserver:anonymous@198.186.203.37:/cvsroot/fikus-parisc
**      cvs -z3 co fikus/arch/parisc/kernel/dma-rm.c
**
...
** 
** HP-UX dorks: fikus device driver programming model is totally different
**    than HP-UX's. HP-UX always sets HINT_PREFETCH since it's drivers
**    do special things to work on non-coherent platforms...fikus has to
