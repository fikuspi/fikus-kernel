...
#include <fikus/notifier.h>	/* For notifier support */
#include <fikus/reboot.h>	/* For reboot_notifier stuff */
#include <fikus/init.h>		/* For __init/__exit/... */
#include <fikus/fs.h>		/* For file operations */
#include <fikus/usb.h>		/* For USB functions */
#include <fikus/slab.h>		/* For kmalloc, ... */
#include <fikus/mutex.h>	/* For mutex locking */
#include <fikus/hid.h>		/* For HID_REQ_SET_REPORT & HID_DT_REPORT */
