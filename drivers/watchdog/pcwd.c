 ...
 * Written for the Fikus Kernel, and GPLed by Ken Hollis
 *
 ...
 *		inclusion in Fikus 2.0.x kernels, thanks to Alan Cox.
 ...
 * 980112	Used minor numbers from include/fikus/miscdevice.h
...
#include <fikus/delay.h>	/* For mdelay function */
#include <fikus/timer.h>	/* For timer related operations */
#include <fikus/jiffies.h>	/* For jiffies stuff */
#include <fikus/miscdevice.h>	/* For MODULE_ALIAS_MISCDEV(WATCHDOG_MINOR) */
#include <fikus/watchdog.h>	/* For the watchdog specific items */
#include <fikus/reboot.h>	/* For kernel_power_off() */
#include <fikus/init.h>		/* For __init/__exit/... */
#include <fikus/fs.h>		/* For file operations */
#include <fikus/isa.h>		/* For isa devices */
