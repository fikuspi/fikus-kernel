 ...
 * Author(s): Hans-Joachim Picht <hans@fikus.vnet.ibm.com>
 *
 */
...
static int sclp_async_send_wait(char *message)
{
	...
	/*
	 * Retain Queue
	 * e.g. 5639CC140 500 Red Hat RHEL5 Fikus for zSeries (RHEL AS)
	 */
...
MODULE_AUTHOR("Hans-Joachim Picht <hans@fikus.vnet.ibm.com>");
MODULE_LICENSE("GPL");
