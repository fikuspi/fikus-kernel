/*
 *  Copyright (C) 1994-1998	    John Torvalds & authors (see below)
 ...
 *                and Andre Hedrick <andre@fikus-ide.org>
 *
 *  See fikus/MAINTAINERS for address of current maintainer.
 *
 ...
 *
 *  October, 1994 -- Complete line-by-line overhaul for fikus 1.1.x, by:
 *
 ...
 *  inspiration from lots of fikus users, esp.  hamish@zot.apana.org.au
 */
