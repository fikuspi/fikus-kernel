...
#include <fikus/rtc.h>
#include <fikus/bcd.h>
#include <fikus/rtc/ds1307.h>

/*
 * We can't determine type by probing, but if we expect pre-Fikus code
 * to have set the chip up as a clock (turning on the oscillator and
 * setting the date and time), Fikus can ignore the non-clock features.
