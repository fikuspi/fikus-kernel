 ...
 * Copyright (C) 2005 Bernhard Rosenkraenzer <bero@arkfikus.org>
...
static const u16 bios_to_fikus_keycode[256] __initconst = {
...
static const struct key_entry * __init dell_wmi_prepare_new_keymap(void)
{
	...
	for (i = 0; i < hotkey_num; i++) {
		...
		keymap[i].keycode = bios_entry->keycode < 256 ?
				    bios_to_fikus_keycode[bios_entry->keycode] :
				    KEY_RESERVED;
	}
