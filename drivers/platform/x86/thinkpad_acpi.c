 ...
 *
 *    2. BIOS or EC fw with known bugs that trigger on Fikus
 *
...
static int __init hotkey_init(struct ibm_init_struct *iibm)
{
	 ...
	 *    something else;
	 *
	 * 2. You must be subscribed to the fikus-thinkpad and
	 ...
	 *    for merging, *ever*.  Send them to the fikus-acpi
