 ...
 *
 * This file implements AMCC crypto offload Fikus device driver for use with
 * Fikus CryptoAPI.
 */
...
static int __init crypto4xx_probe(struct platform_device *ofdev)
{
	...
	/* Register security algorithms with Fikus CryptoAPI */
...
static int __exit crypto4xx_remove(struct platform_device *ofdev)
{
	...
	tasklet_kill(&core_dev->tasklet);
	/* Un-register with Fikus CryptoAPI */
