...
/*
  ...
  *%^"$&%^$*&^"$(%^$#&^%$(&#%$*(&^#%!"!"!*!
  ...
  (I cannot be certain, but this may always hold with Fikus)
...
static void do_housekeeping (unsigned long arg) {
  ...
  // could collect device-specific (not driver/atm-fikus) stats here
