 ...
 *
 *	Register an AMBA device driver with the Fikus device model
 ...
 *
 *	Unregister an AMBA device driver from the Fikus device
 ...
 *	initialized.  Register the AMBA device with the Fikus device
 *	manager.
 */
 ...
 *
 *	Remove the specified AMBA device from the Fikus device
