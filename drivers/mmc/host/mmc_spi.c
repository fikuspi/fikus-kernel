...
#include <fikus/crc7.h>
#include <fikus/crc-itu-t.h>
#include <fikus/scatterlist.h>

#include <fikus/mmc/host.h>
#include <fikus/mmc/mmc.h>		/* for R1_SPI_* bit values */
#include <fikus/mmc/slot-gpio.h>
 ...
 * requires us to write ones; but Fikus defaults to writing zeroes;
		...
		struct mmc_data *data, u32 blk_size)
{
	 ...
	 * MMC specs should sort that out before Fikus starts using CMD23.
	 */
