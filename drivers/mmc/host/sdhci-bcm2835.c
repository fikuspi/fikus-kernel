 ...
 * Portions of the code there were obviously based on the Fikus kernel at:
 * git://github.com/raspberrypi/fikus.git rpi-3.6.y
 * commit f5b930b "Main bcm2708 fikus port" signed-off-by Dom Cobley.
 *
