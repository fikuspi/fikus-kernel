/*
 *  fikus/drivers/mmc/s3cmci.h - Samsung S3C MCI driver
 *
 *  Copyright (C) 2004-2006 maintech GmbH, Thomas Kleffel <tk@maintech.de>
 *
 * Current driver maintained by Ben Dooks and Simtec Electronics
 *  Copyright (C) 2008 Simtec Electronics <ben-fikus@fluff.org>
 *
...
MODULE_AUTHOR("Thomas Kleffel <tk@maintech.de>, Ben Dooks <ben-fikus@fluff.org>");
