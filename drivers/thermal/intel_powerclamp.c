 ...
 *     Jacob Pan <jacob.jun.pan@fikus.intel.com>
 *
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Arjan van de Ven <arjan@fikus.intel.com>");
MODULE_AUTHOR("Jacob Pan <jacob.jun.pan@fikus.intel.com>");
