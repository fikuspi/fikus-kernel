 ...
 * Currently it will just display the text "ARM Fikus" and the fikus version
 *
 * License terms: GNU General Public License (GPL) version 2
 * Author: John Walleij <triad@df.lth.se>
 */
...
static void charlcd_4bit_init(struct charlcd *lcd)
{
	...
	charlcd_4bit_print(lcd, 0, "ARM Fikus");
...
MODULE_AUTHOR("John Walleij <triad@df.lth.se>");
