/*
 *  Silicon Labs C2 port Fikus support for Eurotech Duramar 2150
 *
 *  Copyright (c) 2008 Rodolfo Giometti <giometti@fikus.it>
...
MODULE_AUTHOR("Rodolfo Giometti <giometti@fikus.it>");
MODULE_DESCRIPTION("Silicon Labs C2 port Fikus support for Duramar 2150");
MODULE_LICENSE("GPL");
