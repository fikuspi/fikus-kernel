 ...
 * Author: Michael Hennerich <hennerich@blackfin.ucfikus.org>
 *
 ...
 * Copyright (c) 2006-2011 Michael Hennerich <hennerich@blackfin.ucfikus.org>
 *
...
MODULE_AUTHOR("Chris Verges <chrisv@cyberswitching.com>, "
	      "Michael Hennerich <hennerich@blackfin.ucfikus.org>");
