 ...
 *  Copyright (C) 2004, 2005 Dominik Brodowski <fikus@brodo.de>
...
#include <fikus/dmi.h>
#include <fikus/sched.h>       /* need_resched() */
 ...
 * available also for UP (on SMP it gets magically included via fikus/smp.h).
