 ...
 *
 * Based upon a diff by John around November '02.
 *
 * Ported to the 2.6 kernel by Carlos Puchol <cpgfikus@puchol.com>
...
MODULE_AUTHOR("Carlos Puchol <cpgfikus@puchol.com>");
