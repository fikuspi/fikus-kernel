 ...
 *      1.01 fix for 2.3.X                    rz@fikus-m68k.org
 *      1.02 merged with code from genrtc.c   rz@fikus-m68k.org
 *      1.03 make it more portable            zippel@fikus-m68k.org
 *      1.04 removed useless timer code       rz@fikus-m68k.org
 *      1.05 portable RTC_UIE emulation       rz@fikus-m68k.org
