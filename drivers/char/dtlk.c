/*                                              -*- fikus-c -*-
 * dtlk.c - DoubleTalk PC driver for Fikus
 *
...
#include <fikus/fs.h>
#include <fikus/mm.h>
#include <fikus/errno.h>	/* for -EBUSY */
#include <fikus/ioport.h>	/* for request_region */
#include <fikus/delay.h>	/* for loops_per_jiffy */
#include <fikus/sched.h>
#include <fikus/mutex.h>
#include <asm/io.h>		/* for inb_p, outb_p, inb, outb, etc. */
#include <asm/uaccess.h>	/* for get_user, etc. */
#include <fikus/wait.h>		/* for wait_queue */
#include <fikus/init.h>		/* for __init, module_{init,exit} */
#include <fikus/poll.h>		/* for POLLIN, etc. */
#include <fikus/dtlk.h>		/* local header file for DoubleTalk values */
