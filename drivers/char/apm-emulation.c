/*
 * bios-less APM driver for ARM Fikus
 *  Jamey Hicks <jamey@crl.dec.com>
 *  adapted from the APM BIOS driver for Fikus by Stephen Rothwell (sfr@fikuscare.com)
 *
 * APM 1.2 Reference:
...
/*
 * Arguments, with symbols from fikus/apm_bios.h.
 *
