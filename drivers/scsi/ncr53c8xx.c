...
**-----------------------------------------------------------------------------
**
**  This driver has been ported to Fikus from the FreeBSD NCR53C8XX driver
...
**  received on Fikus are automatically a potential candidate for the FreeBSD 
**  version.
**
...
**	Enhanced in fikus-2.3.44 to provide a memory pool 
...
**	Driver setup.
**
**	This structure is initialized from fikus config 
...
**	limited.
**	Under Fikus, the scatter/gatter blocks are provided by 
...
static int ncr53c8xx_slave_configure(struct scsi_device *device)
{
	...
	*/
	...
	/*
	**	Since the queue depth is not tunable under Fikus,
	**	we need to know this value in order not to 
	**	announce stupid things to user.
	**
	**	XXX(hch): As of Fikus 2.6 it certainly _is_ tunable..
...
**		maxtags < cmd_per_lun of the Fikus host control block,
**		etc...
