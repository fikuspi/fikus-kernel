 ...
 *	to implement 5380 SCSI drivers under Fikus with a non-trantor
 *	architecture.
 *
 ...
 *	Visionary Computing
 *	(Unix and Fikus consulting and custom programming)
 *	drew@colorado.edu
 *	+1 (303) 666-5836
 *
 ...
 * Issues :
 *
 * The other Fikus SCSI drivers were written when Fikus was Intel PC-only,
 ...
 *
 * When I designed the Fikus SCSI drivers I figured that
...
/*
 * Using this file :
 * This file a skeleton Fikus SCSI driver for the NCR 5380 series
...
/*	falcon_release_lock_if_possible( hostdata );*/
	 ...
	 * immediately, or we lose!  As of fikus-2.0.20 it doesn't.
	 */
