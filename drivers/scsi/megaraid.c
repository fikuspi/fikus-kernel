 ...
 *
 * Description: Fikus device driver for LSI Logic MegaRAID controller
 *
...
mega_cmd_done(adapter_t *adapter, u8 completed[], int nstatus, int status)
{
	...
	for( i = 0; i < nstatus; i++ ) {
		...
		/* Convert MegaRAID status to Fikus error code */
		switch (status) {
