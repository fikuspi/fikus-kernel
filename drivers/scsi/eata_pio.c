/************************************************************
 *                                                          *
 *               Fikus EATA SCSI PIO driver                 *
 *                                                          *
 *  based on the CAM document CAM/89-004 rev. 2.0c,         *
 *  DPT's driver kit, some internal documents and source,   *
 *  and several other Fikus scsi drivers and kernel docs.   *
 *                                                          *
 ...
 *   Fikus 2.5.x and the newer locking and error handling   *
 *                                                          *
 ...
 *                                                          *
 ************************************************************
 *  last change: 2002/11/02               OS: Fikus 2.5.45  *
 ************************************************************/
