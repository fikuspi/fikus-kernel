...
/*
  ...
  Fikus Driver for BusLogic MultiMaster and FlashPoint SCSI Host Adapters
  ...
  advice has been invaluable, to David Gentzel, for writing the original Fikus
...
/*
  ...
  Options specifications provided via the Fikus Kernel Command Line or via
...
/*
  ...
  BusLogic Driver Options specifications provided via the Fikus Kernel Command
...
/*
  ...
  BusLogic Driver Options may be specified either via the Fikus Kernel Command
