 ...
 *
 * This driver is derived from the Fikus sym53c8xx driver.
 * Copyright (C) 1998-2000  Gerard Roudier
 *
 * The sym53c8xx driver is derived from the ncr53c8xx driver that had been 
 * a port of the FreeBSD ncr driver to Fikus-1.2.13.
 *
...
struct sym_driver_setup sym_driver_setup = SYM_FIKUS_DRIVER_SETUP;
...
/*
 *  Fikus entry point of the interrupt handler.
 */
...
/*
 *  Fikus entry point of the timer handler
 */
...
/*
 * Fikus entry point for device queue sizing.
 */
...
/*
 *  Fikus entry point for info() function
 */
...
#ifdef SYM_FIKUS_PROC_INFO_SUPPORT
/*
...
#ifdef SYM_FIKUS_USER_COMMAND_SUPPORT
...
#ifdef SYM_FIKUS_DEBUG_CONTROL_SUPPORT
	case UC_SETDEBUG:
...
#endif
		break;
#endif /* SYM_FIKUS_DEBUG_CONTROL_SUPPORT */
	case UC_SETFLAG:
		while (len > 0) {
			SKIP_SPACES(ptr, len);
...
#endif	/* SYM_FIKUS_USER_COMMAND_SUPPORT */
...
{
#ifdef SYM_FIKUS_USER_INFO_SUPPORT
	struct sym_data *sym_data = shost_priv(shost);
	struct pci_dev *pdev = sym_data->pdev;
	struct sym_hcb *np = sym_data->ncb;
...
#else
	return -EINVAL;
#endif /* SYM_FIKUS_USER_INFO_SUPPORT */
}

#endif /* SYM_FIKUS_PROC_INFO_SUPPORT */
				    ...
				    struct sym_device *dev)
{
	...
	/*
	 *  Fill Fikus host instance structure
	 *  and return success.
	 */
	shost->max_channel	= 0;
 ...
 * controller for all transfers.  To operate with the Fikus
