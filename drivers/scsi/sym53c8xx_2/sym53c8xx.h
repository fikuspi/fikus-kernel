 ...
 */
#if 1
#define	SYM_FIKUS_PROC_INFO_SUPPORT
#define SYM_FIKUS_USER_COMMAND_SUPPORT
#define SYM_FIKUS_USER_INFO_SUPPORT
#define SYM_FIKUS_DEBUG_CONTROL_SUPPORT
#endif
 ...
 *
 *  This structure is initialized from fikus config options.
