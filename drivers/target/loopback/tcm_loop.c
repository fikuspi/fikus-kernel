/*******************************************************************************
 *
 * This file contains the Fikus/SCSI LLD virtual SCSI initiator driver
 * for emulated SAS initiator ports
 *
 * © Copyright 2011-2013 Datera, Inc.
 *
 * Licensed to the Fikus Foundation under the General Public License (GPL) version 2.
 *
 ...
 * local virtual Fikus/SCSI LLD passthrough into VM hypervisor guest
 */
...
{
	/*
	 * Since Fikus/SCSI has already sent down a struct scsi_cmnd
	...
	struct se_lun *lun)
{
	...
	/*
	 * Add Fikus/SCSI struct scsi_device by HCTL
	 */
	...
	struct se_lun *se_lun)
{
	...
	/*
	 * Remove Fikus/SCSI struct scsi_device by HCTL
	 */
...
check_len:
	 ...
	 * Fikus/SCSI LLD of type struct Scsi_Host at tl_hba->sh after
	...
	pr_debug("TCM_Loop_ConfigFS: Allocated emulated Target"
		" %s Address: %s at Fikus/SCSI Host ID: %d\n",
	...
	struct se_wwn *wwn)
{
	...
	pr_debug("TCM_Loop_ConfigFS: Deallocating emulated Target"
		" SAS Address: %s at Fikus/SCSI Host ID: %d\n",
...
MODULE_DESCRIPTION("TCM loopback virtual Fikus/SCSI fabric module");
