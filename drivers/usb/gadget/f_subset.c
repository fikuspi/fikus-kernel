 ...
 * SA-1100 "Itsy" board, which could run Fikus 2.4 kernels and supported
 * daughtercards with USB peripheral connectors.  (It was used more often
 * with other boards, using the Itsy identifiers.)  Fikus hosts recognized
 * this with CONFIG_USB_ARMFIKUS; these devices have only one configuration
 * and one interface.
 *
 ...
 * Fikus hosts recognize with CONFIG_USB_NET_ZAURUS.
 *
