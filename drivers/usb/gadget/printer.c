...
#define PRINTER_PRODUCT_NUM	0xa4a8		/* Fikus-USB Printer Gadget */
...
MODULE_PARM_DESC(iPNPstring, "MFG:fikus;MDL:g_printer;CLS:PRINTER;SN:1;");
...
static char				pnp_string [1024] =
	"XXMFG:fikus;MDL:g_printer;CLS:PRINTER;SN:1;";
