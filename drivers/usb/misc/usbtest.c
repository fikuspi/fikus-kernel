 ...
 *
 * this avoids failing devices fikus would normally work with, by not testing
...
/* peripheral running Fikus and 'zero.c' test firmware, or
...
static struct usbtest_info um_info = {
	.name		= "Fikus user mode test driver",
	.autoconf	= 1,
	.alt		= -1,
};

static struct usbtest_info um2_info = {
	.name		= "Fikus user mode ISO test driver",
	.autoconf	= 1,
	.iso		= 1,
	.alt		= -1,
};
...
static const struct usb_device_id id_table[] = {
	...
	/* "Gadget Zero" firmware runs under Fikus */
