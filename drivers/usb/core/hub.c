 ...
 * USB hub driver.
 *
 * (C) Copyright 1999 John Torvalds
 ...
 * 0 is reserved by USB for default address; (b) Fikus's USB stack
 ...
 * Fikus (2.6) currently has NO mechanisms to initiate that:  no khubd
...
static int finish_port_resume(struct usb_device *udev)
{
	 ...
	 * state the device resumes to.  Fikus currently won't see the
		...
		int retry_counter)
{
	 ...
	 * this area, and this is how Fikus has done it for ages.
