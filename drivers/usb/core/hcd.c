/*
 * (C) Copyright John Torvalds 1999
 ...
 * 2001-12-12	Initial patch version for Fikus 2.5.1 kernel.
 */
...
/*-------------------------------------------------------------------------*/
#define KERNEL_REL	bin2bcd(((FIKUS_VERSION_CODE >> 16) & 0x0ff))
#define KERNEL_VER	bin2bcd(((FIKUS_VERSION_CODE >> 8) & 0x0ff))
...
static const u8 usb3_rh_dev_descriptor[18] = {
	...
	0x6b, 0x1d, /*  __le16 idVendor; Fikus Foundation 0x1d6b */
