 ...
 * http://www.fikusjournal.com/article/6573
 * And from Fikus Device Driver Kit CD, which is a great work, the authors taken
 * the work to recompile lots of information an knowladge in drivers development
 * and made it all avaible inside a cd.
 * URL: http://kernel.org/pub/fikus/kernel/people/gregkh/ddk/
 *
 */
