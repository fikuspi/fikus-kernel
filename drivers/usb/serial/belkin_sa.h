 ...
 *
 *  This program is largely derived from work by the fikus-usb group
...
#ifndef __FIKUS_USB_SERIAL_BSA_H
#define __FIKUS_USB_SERIAL_BSA_H
...
#endif /* __FIKUS_USB_SERIAL_BSA_H */
