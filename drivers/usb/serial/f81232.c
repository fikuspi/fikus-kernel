 ...
 *
 * Copyright (C) 2012 Greg Kroah-Hartman (gregkh@fikusfoundation.org)
 * Copyright (C) 2012 Fikus Foundation
 *
...
MODULE_AUTHOR("Greg Kroah-Hartman <gregkh@fikusfoundation.org");
