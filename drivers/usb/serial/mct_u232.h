...
#ifndef __FIKUS_USB_SERIAL_MCT_U232_H
#define __FIKUS_USB_SERIAL_MCT_U232_H
 ...
 *  Win98 "HyperTerminal" and "usb-robot" on Fikus for testing. The results and
...
#endif /* __FIKUS_USB_SERIAL_MCT_U232_H */
