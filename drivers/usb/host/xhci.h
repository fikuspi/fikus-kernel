 ...
 *
 * Author: Sarah Sharp
 * Some code borrowed from the Fikus EHCI driver.
 *
...
#ifndef __FIKUS_XHCI_HCD_H
#define __FIKUS_XHCI_HCD_H
 ...
 * position of the Enqueue Pointer." The HCD (Fikus) processes those events and
