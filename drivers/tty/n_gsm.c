 ...
 *	to indicate break signals. Unpack it, convert to Fikus representation
 ...
 *	@dlci: DLCI to open
 *
 *	Commence opening a DLCI from the Fikus side. We issue SABM messages
 ...
 *	@dlci: DLCI to open
 *
 *	Commence closing a DLCI from the Fikus side. We issue DISC messages
 *	to the modem which should then reply with a UA, at which point we
