 ...
 *
 * Author(s):	Hendrik Brueckner <brueckner@fikus.vnet.ibm.com>
 */
...
struct hvc_iucv_private {
	...
	unsigned char		is_console;	/* Fikus console usage flag */
 ...
 * @is_console:		Flag if the instance is used as Fikus console
 *
