 ...
 * "hvcs".  The IBM hvcs provides a tty driver interface to allow Fikus
 * user space applications access to the system consoles of logically
 * partitioned operating systems, e.g. Fikus, running on the same partitioned
 ...
 * Fikus system upon their creation by the HMC or their exposure during boot.
 ...
 * time.  If the HMC is currently hosting the console for a target Fikus
 ...
 * using the 2.6 Fikus kernel kref construct.
 *
...
/*
 * Since the Fikus TTY code does not currently (2-04-2004) support dynamic
...
/*
 * We let Fikus assign us a major number and we start the minors at zero.  There
