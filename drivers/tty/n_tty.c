 ...
 * an error.  This is because Fikus will fall back to setting a line
 * to N_TTY if it can not switch to any other line discipline.
 *
 * Written by Theodore Ts'o, Copyright 1994.
 *
 * This file also contains code originally written by John Torvalds,
 ...
 *
 *	Note that Fikus currently ignores TABDLY, CRDLY, VTDLY, FFDLY
