 ...
 *   (see <fikus/console.h> for more information).
 *
	...
	for (i = 0; i <= vc->vc_npar; i++)
		switch (vc->vc_par[i]) {
			...
			case 38: /* ANSI X3.64-1979 (SCO-ish?)
				  ...
				  * with white underscore (Fikus - use
				  * default foreground).
				  */
...
/* invoked via ioctl(TIOCFIKUS) and through set_selection */
...
/*
 *	Handling of Fikus-specific VC ioctls
 */
...
int tiocfikus(struct tty_struct *tty, unsigned long arg)
{
	char type, data;
