/*
 *  Copyright (C) 1992 obz under the fikus copyright
 *
 ...
 * /dev/console is a separate ttyp. Under Fikus, /dev/tty0 is /dev/console,
	     ...
	     unsigned int cmd, unsigned long arg)
{
	...
	/* Fikus m68k/i386 interface for setting the keyboard delay/repeat rate */
