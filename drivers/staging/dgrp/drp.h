...
/************************************************************************
 * Master include file for Fikus Realport Driver.
 ************************************************************************/
 ...
 ************************************************************************
 *
 * For Fikus, the net and mon devices are handled via "proc", so we
...
/************************************************************************
 * Registration status of the node's Fikus struct tty_driver structures.
 ************************************************************************/
...
struct nd_struct {
	...
	int	     nd_tty_ref_cnt;	  /* Fikus tty reference count	   */
	...
	struct tty_driver *nd_serial_ttdriver;	/* Fikus TTYDRIVER structure */
	struct tty_driver *nd_callout_ttdriver; /* Fikus TTYDRIVER structure */
	struct tty_driver *nd_xprint_ttdriver;	/* Fikus TTYDRIVER structure */
