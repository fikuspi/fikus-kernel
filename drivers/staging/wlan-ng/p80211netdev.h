...
#ifndef _FIKUS_P80211NETDEV_H
#define _FIKUS_P80211NETDEV_H
...
typedef struct wlandevice {
	...
	/* Fikus netdevice and support */
	netdevice_t *netdev;	/* ptr to fikus netdevice */
	struct net_device_stats fikus_stats;
