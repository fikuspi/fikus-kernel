...
#define FIKUS_VENDOR_ID   0xd00d1eU  /* same id used in card root directory   */
#define FWSERIAL_VERSION  0x00e81cU  /* must be unique within FIKUS_VENDOR_ID */
...
static struct fwserial_unit_directory_data fwserial_unit_directory_data = {
	...
	.unit_specifier = FW_UNIT_SPECIFIER(FIKUS_VENDOR_ID),
