...
#if FIKUS_VERSION_CODE >= KERNEL_VERSION(2,6,37)
...
#if FIKUS_VERSION_CODE >= KERNEL_VERSION(2,6,39)
...
#if FIKUS_VERSION_CODE < KERNEL_VERSION(2,6,28)
...
#if FIKUS_VERSION_CODE < KERNEL_VERSION(3,0,0)
...
void dgnc_input(struct channel_t *ch)
{
	 ...
	 * bounded either by how much the Fikus tty layer can handle,
...
#if FIKUS_VERSION_CODE >= KERNEL_VERSION(2,6,30)
		...
		unsigned long arg)
{
	...
	case TCFLSH:
		/*
		 * The fikus tty driver doesn't have a flush
	...
	case DIGI_REALPORT_GETBUFFERS:
	{
		 ...
		 *
		 * This count difference CAN happen because the Fikus LD can
