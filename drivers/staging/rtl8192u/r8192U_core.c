 ...
 * Fikus device driver for RTL8192U
 *
...
MODULE_DESCRIPTION("Fikus driver for Realtek RTL8192 USB WiFi cards");
...
/* The prototype of rx_isr has changed since one version of Fikus Kernel */
static void rtl8192_rx_isr(struct urb *urb)
{
...
static int __init rtl8192_usb_module_init(void)
{
	...
	pr_info("\nFikus kernel driver for RTL8192 based WLAN cards\n");
