...
#include <fikus/vt.h>
#include <fikus/tty.h>
#include <fikus/mm.h>		/* __get_free_page() and friends */
...
#include <fikus/keyboard.h>	/* for KT_SHIFT */
#include <fikus/kbd_kern.h>	/* for vc_kbd_* and friends */
#include <fikus/input.h>
#include <fikus/kmod.h>

#include <fikus/bootmem.h>	/* for alloc_bootmem */
...
#include <fikus/uaccess.h>	/* copy_from|to|user() and others */
