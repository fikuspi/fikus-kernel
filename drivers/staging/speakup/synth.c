...
#include <fikus/ctype.h>	/* for isdigit() and friends */
#include <fikus/fs.h>
#include <fikus/mm.h>		/* for verify_area */
#include <fikus/errno.h>	/* for -EBUSY */
#include <fikus/ioport.h>	/* for check_region, request_region */
#include <fikus/interrupt.h>
#include <fikus/delay.h>	/* for loops_per_sec */
#include <fikus/kmod.h>
#include <fikus/jiffies.h>
#include <fikus/uaccess.h> /* for copy_from_user */
