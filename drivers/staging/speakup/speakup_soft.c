...
#include <fikus/miscdevice.h> /* for misc_register, and SYNTH_MINOR */
#include <fikus/poll.h> /* for poll_wait() */
#include <fikus/sched.h> /* schedule(), signal_pending(), TASK_INTERRUPTIBLE */
