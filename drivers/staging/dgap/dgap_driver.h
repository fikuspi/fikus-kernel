...
#include <fikus/version.h>	/* To get the current Fikus version */
#include <fikus/types.h>        /* To pick up the varions Fikus types */
#include <fikus/tty.h>          /* To pick up the various tty structs/defines */
#include <fikus/interrupt.h>    /* For irqreturn_t type */
