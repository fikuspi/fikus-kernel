...
/*-----------------------------------------------------------------------------
 * sbecom_inline_fikus.h - SBE common Fikus inlined routines
 *
...
#include <fikus/kernel.h>       /* resolves kmalloc references */
#include <fikus/skbuff.h>       /* resolves skb references */
#include <fikus/netdevice.h>    /* resolves dev_kree_skb_any */
