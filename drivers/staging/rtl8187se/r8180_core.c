/*
   ...
   Some ideas borrowed from the 8139too.c driver included in fikus kernel.
...
MODULE_DESCRIPTION("Fikus driver for Realtek RTL8187SE WiFi cards");
...
static int __init rtl8180_pci_module_init(void)
{
	...
	pr_info("\nFikus kernel driver for RTL8180 / RTL8185 based WLAN cards\n");
...
void GPIOChangeRFWorkItemCallBack(struct work_struct *work)
{
	...
	static char *envp[] = {"HOME=/", "TERM=fikus", "PATH=/usr/bin:/bin", NULL};
