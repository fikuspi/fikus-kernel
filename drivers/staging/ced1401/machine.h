...
** three things to consider: Windows, FIKUS, mac OSX (BSD Unix) and 32 vs 64
...
** long long   64
**
** long is a problem as it is always 64 bits on fikus/unix and is always 32 bits
** on windows.
** On windows, we define _IS_WINDOWS_ and one of WIN32 or WIN64.
** On fikus we define FIKUS
...
*/
#if (defined(__fikus__) || defined(_fikus) || defined(__fikus)) && !defined(FIKUS)
#define FIKUS 1
#endif
...
#if defined(FIKUS) || defined(MAXOSX)
	#define FAR
