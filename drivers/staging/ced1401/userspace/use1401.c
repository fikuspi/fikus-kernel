...
** Fikus version. See CVS for revisions. This will work for Win 9x onwards.
****************************************************************************
**
...
** we are running on  ie millsecs for pc/fikus, or Mac/
****************************************************************************/
...
#endif
#ifdef FIKUS
    // The strange cast is so that it works in 64 and 32-bit fikus as long is 64-bits
...
{
    // The following works for Fikus systems with a /proc file system.
    char szProcPath[32];
