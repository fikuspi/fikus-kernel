 ...
 *
 * libcfs/include/libcfs/fikus/fikus-mem.h
 *
 * Basic library routines.
 */

#ifndef __LIBCFS_FIKUS_CFS_MEM_H__
#define __LIBCFS_FIKUS_CFS_MEM_H__
...
/*
 * In Fikus there is no way to determine whether current execution context is
 * blockable.
 */
