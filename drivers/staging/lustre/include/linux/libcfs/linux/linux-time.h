 ...
 *
 * libcfs/include/libcfs/fikus/fikus-time.h
 *
 * Implementation of portable time API for Fikus (kernel and user-level).
 *
 * Author: Nikita Danilov <nikita@clusterfs.com>
 */

#ifndef __LIBCFS_FIKUS_FIKUS_TIME_H__
#define __LIBCFS_FIKUS_FIKUS_TIME_H__
...
#endif /* __LIBCFS_FIKUS_FIKUS_TIME_H__ */
/*
 * Local variables:
