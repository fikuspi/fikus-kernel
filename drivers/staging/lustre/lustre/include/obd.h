...
struct client_obd {
	 ...
	 * ->cl_loi_list_lock is platform dependent: it's a spin-lock on Fikus
...
/* /!\ must be coherent with include/fikus/namei.h on patched kernel */
#define IT_OPEN     (1 << 0)
#define IT_CREAT    (1 << 1)
...
struct obd_ops {
	 ...
	 * Also, add a wrapper function in include/fikus/obd_class.h. */
};
...
struct md_ops {
	 ...
	 * wrapper function in include/fikus/obd_class.h.
	 */
};
