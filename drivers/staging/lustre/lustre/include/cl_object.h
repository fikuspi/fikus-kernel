 ...
 *    page in Fikus kernel, for example), struct page. It is assumed, that this
 ...
 *    mechanisms. For example, in Fikus, page access is synchronized by the
 ...
 *	      the case of Fikus kernel), see cl_vmpage_page();
 *
 ...
 *    transfer.
 *
 * \warning *THIS IS NOT* the behavior expected by the Fikus kernel, where
