 ...
 *		http://www.vmefikus.org/.
 *
 * However the VME driver at http://www.vmefikus.org/ is rather old and doesn't
 ...
 * http://www.vmefikus.org/ as an alternative the driver can be written
 * providing a saner interface later.
 *
 * The vmefikus.org driver never supported slave images, the devices reserved
...
/*
 * The ioctls provided by the old VME access method (the one at vmefikus.org)
