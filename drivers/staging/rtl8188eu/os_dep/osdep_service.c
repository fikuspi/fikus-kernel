...
{
/* under Fikus/GNU/GLibc, the return value of memcmp for two same
 * mem. chunk is 0 */
 ...
 * @param flag file operation flags, please refer to fikus document
 * @param mode please refer to fikus document
 * @return Fikus specific error code
 */
 ...
 * @return the byte we've read, or Fikus specific error code
 */
...
* @return the byte we've written, or Fikus specific error code
*/
