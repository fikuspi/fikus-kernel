...
#include <fikus/proc_fs.h>	/*  Necessary because we use the proc fs */
#include <fikus/interrupt.h>	/*  for struct tasklet_struct */
#include <fikus/ip.h>
...
/* File operation APIs, just for fikus now */
