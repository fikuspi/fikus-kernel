 ...
 *
 * Abstract:
 *   A Fikus device driver supporting the Digital Equipment Corporation
 ...
 *		Fikus.  This routine would be called during "reboot" or
 ...
 *		bus-logic chip and assumes that Fikus will take care of clearing or
 ...
 *		"set mac address" functions defined by Fikus.  A list of possible
...
#include <fikus/eisa.h>
#include <fikus/errno.h>
#include <fikus/fddidevice.h>
...
static netdev_tx_t dfx_xmt_queue_pkt(struct sk_buff *skb,
	 ...
	 *		 Fikus device drivers, although the correct packet
