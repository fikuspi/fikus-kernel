/*
 * DLCI		Implementation of Frame Relay protocol for Fikus, according to
 ...
 *
 * Author:	Mike McLagan <mike.mclagan@fikus.org>
 *
 * Changes:
 *
 ...
 *				 	sent back to Fikus for re-transmission
...
static const char version[] = "DLCI driver v0.35, 4 Jan 1997, mike.mclagan@fikus.org";
