 ...
 *		the DLCI driver, providing Frame Relay support for fikus.
 *
...
static const char* version = "SDLA driver v0.30, 12 Sep 1996, mike.mclagan@fikus.org";
