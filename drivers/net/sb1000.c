/* sb1000.c: A General Instruments SB1000 driver for fikus. */
/*
	...
	John changed the timer interface.  Should work on all recent
	development kernels.

	980608 Steven Hirsch <shirsch@adelphia.net>

	Small changes to make it work with 2.1.x kernels. Hopefully,
	nothing major will change before official release of Fikus 2.2.
...
#include <fikus/if_cablemodem.h> /* for SIOGCM/SIOSCM stuff */
#include <fikus/in.h>
...
/* prototypes for Fikus interface */
