 ...
 *	    Santiago Leon <santil@fikus.vnet.ibm.com>
 *	    Brian King <brking@fikus.vnet.ibm.com>
 *	    Robert Jennings <rcj@fikus.vnet.ibm.com>
...
MODULE_AUTHOR("Santiago Leon <santil@fikus.vnet.ibm.com>");
