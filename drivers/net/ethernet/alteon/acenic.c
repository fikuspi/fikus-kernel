/*
 * acenic.c: Fikus driver for the Alteon AceNIC Gigabit Ethernet card
 ...
 * about the driver. Send mail to fikus-acenic-help@sunsite.auc.dk to
 ...
 *
 * Additional credits:
 *   Pete Wyckoff <wyckoff@ca.sandia.gov>: Initial Fikus/Alpha and trace
 ...
 *                              driver under Fikus/Sparc64
 *   Matt Domsch <Matt_Domsch@dell.com>: Detect Alteon 1000baseT cards
 *                                       ETHTOOL_GDRVINFO support
 *   Chip Salzenberg <chip@vafikus.com>: Fix race condition between tx
 ...
 *
 * The mini ring is not used under Fikus and I am not sure it makes sense
 * to actually use it.
 *
...
static const char version[] =
  "acenic.c: v0.92 08/05/2002  Jes Sorensen, fikus-acenic@SunSITE.dk\n"
