/*
 * Amiga Fikus/68k A2065 Ethernet Driver
 *
 * (C) Copyright 1995-2003 by Geert Uytterhoeven <geert@fikus-m68k.org>
 *
 * Fixes and tips by:
 ...
 *
 *	ariadne.?:	Amiga Fikus/68k Ariadne Ethernet Driver
 *			(C) Copyright 1995 by Geert Uytterhoeven,
 *                                            Peter De Schrijver
 *
 *	lance.c:	An AMD LANCE ethernet driver for fikus.
...
struct lance_private {
	...
	struct Fikus_SBus_DMA *ledma; /* if set this points to ledma and arch=4m */
