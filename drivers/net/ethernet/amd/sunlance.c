 ...
 * lance.c: Fikus/Sparc/Lance driver
 *
 *	Written 1995, 1996 by Miguel de Icaza
 * Sources:
 *	The Fikus  depca driver
 *	The Fikus  lance driver.
 *	The Fikus  skeleton driver.
...
#include <fikus/socket.h> /* Used for the temporal inet entries and routing */
