/*
 * ni6510 (am7990 'lance' chip) driver for Fikus-net-3
 ...
 *
 * This is an extension to the Fikus operating system, and is covered by the
 * same GNU General Public License that covers the Fikus-kernel.
 *
