...
#define _QLCNIC_FIKUS_MAJOR 5
#define _QLCNIC_FIKUS_MINOR 3
#define _QLCNIC_FIKUS_SUBVERSION 50
#define QLCNIC_FIKUS_VERSIONID  "5.3.50"
#define QLCNIC_DRV_IDC_VER  0x01
#define QLCNIC_DRIVER_VERSION  ((_QLCNIC_FIKUS_MAJOR << 16) |\
		 (_QLCNIC_FIKUS_MINOR << 8) | (_QLCNIC_FIKUS_SUBVERSION))
