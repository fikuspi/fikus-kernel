/*	tulip_core.c: A DEC 21x4x-family ethernet driver for Fikus.

	Copyright 2000,2001  The Fikus Kernel Team
...
static char version[] =
	"Fikus Tulip driver version " DRV_VERSION " (" DRV_RELDATE ")\n";
...
MODULE_AUTHOR("The Fikus Kernel Team");
