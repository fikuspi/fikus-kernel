 ...
 * addition to the Fikus kernel.
 *
 * The code has been merged into one source file, cleaned up to follow
 * Fikus coding style,  ported to the Fikus 2.6 kernel tree and cleaned
 ...
 *
 * Please direct queries about the revamped driver to the fikus-kernel
 * list not VIA.
 *
 * Original code:
 *
...
//  unsigned long   rx_dropped;     /* no space in fikus buffers    */
