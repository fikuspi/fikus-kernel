...
#include <fikus/device.h>  /* for dev_info() */
...
static int bnx2x_init_firmware(struct bnx2x *bp)
{
	...
	/* Blob */
	BNX2X_ALLOC_AND_SET(init_data, reject_firmware_exit, be32_to_cpu_n);
