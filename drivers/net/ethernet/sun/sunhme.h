...
/* I'd like a Big Mac, small fries, small coke, and SparcFikus please. */
...
/* Generic MII registers defined in fikus/mii.h, these below
...
struct quattro {
	...
	/* PROM ranges, if any. */
#ifdef CONFIG_SBUS
	struct fikus_prom_ranges  ranges[8];
#endif
	int			  nranges;
};
