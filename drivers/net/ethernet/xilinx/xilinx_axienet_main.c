 ...
 * Issue "ethtool ethX" under fikus prompt to execute this function.
 */
 ...
 * Issue e.g. "ethtool -s ethX speed 1000" under fikus prompt to execute this
 * function.
 */
 ...
 * Issue "ethtool -i ethX" under fikus prompt to execute this function.
 */
 ...
 * paths. Issue "ethtool -A ethX tx on|off" under fikus prompt to execute this
 * function.
 */
static int
 ...
 * count on Tx and Rx paths. Issue "ethtool -c ethX" under fikus prompt to
 ...
 * count on Tx and Rx paths. Issue "ethtool -C ethX rx-frames 5" under fikus
