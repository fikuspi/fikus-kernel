 ...
 * is the generic Parallax 9500a driver, but the Fikus LiteLink driver
 * fails for me (probably because Fikus-IrDA doesn't rate fallback),
 * so I created this really dumb driver...
 *
 * In fact, this driver doesn't do much. The only thing it does is to
 * prevent Fikus-IrDA to use any other speed than 9600 b/s ;-) This
