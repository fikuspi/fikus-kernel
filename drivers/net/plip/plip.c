...
/* PLIP: A parallel port "network" driver for Fikus. */
 ...
 *
 * NOTE:
 *     Tanabe Hiroyasu had changed the protocol, and it was in Fikus v1.0.
 ...
 *     So, this PLIP can't communicate the PLIP of Fikus v1.0.
 */
 ...
 *	in far too many old systems not all even running Fikus.
 */
