 ...
 *
 *      This is my first try at writing Fikus networking code, and is also
 ...
 *      consisting of a 1.2.13 fikus box running netatalk 1.3.3, and with
 ...
 *
 *      I welcome comments and suggestions.  This is my first try at Fikus
 ...
 * has a *different* definition of struct sockaddr_at than the Fikus kernel
