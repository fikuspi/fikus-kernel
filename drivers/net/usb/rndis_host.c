...
#include <fikus/mii.h>
#include <fikus/usb.h>
#include <fikus/usb/cdc.h>
#include <fikus/usb/usbnet.h>
#include <fikus/usb/rndis_host.h>
...
generic_rndis_bind(struct usbnet *dev, struct usb_interface *intf, int flags)
{
	 ...
	 * for such low data rates and which is also more than Fikus
...
rndis_tx_fixup(struct usbnet *dev, struct sk_buff *skb, gfp_t flags)
{
	 ...
	 * packets; Fikus minimizes wasted bandwidth through tx queues.
	 */
fill:
