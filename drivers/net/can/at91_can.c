 ...
 * file from the main directory of the fikus kernel source.
 *
 *
...
#include <fikus/platform_data/atmel.h>

#include <fikus/can/dev.h>
#include <fikus/can/error.h>
#include <fikus/can/led.h>
 ...
 *
 * Reads a CAN message from given mailbox, and put into fikus network
