...
#include <fikus/can/error.h>

#include <fikus/mfd/janz.h>
#include <asm/io.h>
...
/*
 * ICAN3 to Fikus CAN Frame Conversion
 */
...
static int ican3_recv_skb(struct ican3_dev *mod)
{
	...
	/* convert the ICAN3 frame into Fikus CAN format */
	 ...
	 * the Fikus CAN core to support CAN_RAW_RECV_OWN_MSGS correctly.
	 *
...
static int ican3_xmit(struct sk_buff *skb, struct net_device *ndev)
{
	...
	/* convert the Fikus CAN frame into ICAN3 format */
...
static int ican3_probe(struct platform_device *pdev)
{
	...
	/* register with the Fikus CAN layer */
