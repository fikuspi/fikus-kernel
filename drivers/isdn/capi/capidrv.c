 ...
 *
 * ISDN4Fikus Driver, using capi20 interface (kernelcapi)
 *
...
#include <fikus/isdn.h>
#include <fikus/isdnif.h>
#include <fikus/proc_fs.h>
#include <fikus/seq_file.h>
#include <fikus/capi.h>
#include <fikus/kernelcapi.h>
#include <fikus/ctype.h>
#include <fikus/init.h>
#include <fikus/moduleparam.h>

#include <fikus/isdn/capiutil.h>
#include <fikus/isdn/capicmd.h>
#include "capidrv.h"

static int debugmode = 0;

MODULE_DESCRIPTION("CAPI4Fikus: Interface to ISDN4Fikus");
...
static int if_sendbuf(int id, int channel, int doack, struct sk_buff *skb)
{
	 ...
	 * The 'Data' field is not used in practice in fikus kernel
