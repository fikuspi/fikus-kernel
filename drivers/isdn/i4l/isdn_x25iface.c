 ...
 *
 * Fikus ISDN subsystem, X.25 related functions
 *
 * This software may be used and distributed according to the terms
 * of the GNU General Public License, incorporated herein by reference.
 *
 * stuff needed to support the Fikus X.25 PLP code on top of devices that
...
/* process a frame handed over to us from fikus network layer. First byte
