/*
 * Fikus ISDN subsystem, tty functions and AT-command emulator (linklevel).
 *
 * Copyright 1994-1999  by Fritz Elfert (fritz@isdn4fikus.de)
...
#include <fikus/serial.h> /* ASYNC_* flags */
 ...
 * Modem-functions
 *
 * mostly "stolen" from original Fikus-serial.c and friends.
 *
 ************************************************************/
