 ...
 *
 * header for Fikus ISDN subsystem, functions for synchronous PPP (linklevel).
 *
...
#include <fikus/ppp_defs.h>     /* for PPP_PROTOCOL */
#include <fikus/isdn_ppp.h>	/* for isdn_ppp info */
