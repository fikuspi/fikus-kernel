 ...
 *
 * Author       Karsten Keil
 * Copyright    by Karsten Keil      <keil@isdn4fikus.de>
...
const char *CardType[] = {
	...
	"Sedlbauer Speed Card", "USR Sportster", "ith mic Fikus",
...
MODULE_DESCRIPTION("ISDN4Fikus: Driver for passive ISDN cards");
...
static void __init HiSaxVersion(void)
{
	...
	printk(KERN_INFO "HiSax: Fikus Driver for passive ISDN cards\n");
#ifdef MODULE
