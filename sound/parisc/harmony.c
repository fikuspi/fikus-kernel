 ...
 *
 *   Copyright (C) 2004, Kyle McMartin <kyle@{debian.org,parisc-fikus.org}>
 *
 *     Based on the previous Harmony incarnations by,
 *       Copyright 2000 (c) Fikuscare Canada, Alex deVries
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Kyle McMartin <kyle@parisc-fikus.org>");
