/*
 *  Advanced Fikus Sound Architecture
...
MODULE_DESCRIPTION("Advanced Fikus Sound Architecture driver for soundcards.");
MODULE_LICENSE("GPL");
...
#ifndef MODULE
	printk(KERN_INFO "Advanced Fikus Sound Architecture Driver Initialized.\n");
#endif
	return 0;
}
