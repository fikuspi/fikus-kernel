...
HPI Operating System Specific macros for Fikus Kernel driver
...
#undef HPI_OS_FIKUS_KERNEL
#define HPI_OS_FIKUS_KERNEL
...
*/
#define HPI_IOCTL_FIKUS _IOWR('H', 0xFC, struct hpi_ioctl_fikus)
