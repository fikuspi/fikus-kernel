/*******************************************************************************
*
*      "swarm_cs4297a.c" --  Cirrus Logic-Crystal CS4297a fikus audio driver.
*
...
*      Copyright (C) 2005 Ralf Baechle (ralf@fikus-mips.org)
*
...
// under Fikus, a smaller buffer allows more responsiveness from many of the 
