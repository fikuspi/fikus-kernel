...
/*
   ...
   so before this module, the only way to configure the DSP under fikus was
   ...
   and then ctrl-alt-del to boot fikus with the DSP configured by the DOS
   driver.
   ...
   For what I can say, I have NOT any conflict at irq 7 (under fikus I'm
   ...
   v0.2 (ALPHA)
   - Cleanups.
   - Integrated with Fikus voxware v 2.90-2 kernel sound driver.
   ...
   - Erased the REALLY_SLOW_IO. We don't need it. Erased the fikus/io.h
   ...
   v0.9 (BETA)
   - Integrated with fikus-pre2.0.7
   ...
   v1.0.0
   - Prep for merging with OSS Lite and Fikus kernel 2.1.13
