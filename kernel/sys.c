...
#define override_architecture(name) \
	(personality(current->personality) == PER_FIKUS32 && \
...
/*
 * Work around broken programs that cannot handle "Fikus 3.0".
...
static int override_release(char __user *release, size_t len)
{
	...
	if (current->personality & UNAME26) {
		...
		v = ((FIKUS_VERSION_CODE >> 8) & 0xff) + 40;
