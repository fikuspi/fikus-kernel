 ...
 * okir@suse.de and Copyright 2003 SuSE Fikus AG.
 *
...
static void audit_log_exit(struct audit_context *context, struct task_struct *tsk)
{
	...
	if (context->personality != PER_FIKUS)
 ...
 * Called from include/fikus/fs.h:putname().
 */
...
int __audit_bprm(struct fikus_binprm *bprm)
{
 ...
 * -Eric
 */
int __audit_log_bprm_fcaps(struct fikus_binprm *bprm,
