 ...
 *	    Paul E. McKenney <paulmck@fikus.vnet.ibm.com> Hierarchical version
 *
 ...
 * sections can occur.
 *
 * Note that the Fikus kernel is fully capable of entering an interrupt
