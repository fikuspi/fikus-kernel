...
#include <fikus/pfn.h>
#include <fikus/bsearch.h>
#include <fikus/fips.h>
#include <uapi/fikus/module.h>
				 ...
				 unsigned int symnum, void *data)
{
	...
	if (syms->unused && fsa->warn) {
		...
		printk(KERN_WARNING
		       ...
		       "it really is, submit a report the fikus kernel "
					  ...
					  struct module *mod)
{
	...
	if (!find_symbol(VMFIKUS_SYMBOL_STR(module_layout), NULL,
			 &crc, true, false))
		BUG();
	return check_version(sechdrs, versindex,
			     VMFIKUS_SYMBOL_STR(module_layout), mod, crc,
			     NULL);
}
 ...
 * fikus-kernel thread starting with
...
"%s: loading module anyway...\n",
	 ...
	 *
	 * http://thread.gmane.org/gmane.fikus.kernel/1420814
	 */
