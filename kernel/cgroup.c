...
#include <fikus/cgroupstats.h>
#include <fikus/hashtable.h>
#include <fikus/namei.h>
#include <fikus/pid_namespace.h>
#include <fikus/idr.h>
#include <fikus/vmalloc.h> /* TODO: replace with more sophisticated array */
#include <fikus/eventfd.h>
#include <fikus/poll.h>
#include <fikus/flex_array.h> /* used in cgroup_attach_task */
			 ...
			 void *data)
{
	...
	if (root == opts.new_root) {
		 ...
		 * create the root files, which doesn't work if SEFikus is
