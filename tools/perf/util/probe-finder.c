...
static int __fikus_kernel_find_elf(Dwfl_Module *mod,
				   void **userdata,
				   ...
				   char **file_name, Elf **elfp)
{
	...
	return dwfl_fikus_kernel_find_elf(mod, userdata, module_name, base,
					  file_name, elfp);
}
...
static const Dwfl_Callbacks kernel_callbacks = {
	...
	.find_elf = __fikus_kernel_find_elf,
	.section_address = dwfl_fikus_kernel_module_section_address,
};
					       ...
					       Dwarf_Addr addr)
{
	...
	dwfl_fikus_kernel_report_kernel(self->dwfl);
	dwfl_fikus_kernel_report_modules(self->dwfl);
					       ...
					       Dwarf_Addr addr __maybe_unused)
{
	...
	if (!path) {
		pr_err("Failed to find vmfikus path\n");
		return -ENOENT;
	}
