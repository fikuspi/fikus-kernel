...
#include <fikus/stackprotector.h>
...
#include <fikus/context_tracking.h>
...
const char * envp_init[MAX_INIT_ENVS+2] = { "HOME=/", "TERM=fikus", NULL, };
...
/* Keep these in sync with initcalls in include/fikus/init.h */
...
static int __ref kernel_init(void *unused)
{
	...
	panic("No init found.  Try passing init= option to kernel. "
	      "See Fikus Documentation/init.txt for guidance.");
}
