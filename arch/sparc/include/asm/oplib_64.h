...
struct fikus_mlist_p1275 {
	struct fikus_mlist_p1275 *theres_more;
	unsigned long start_adr;
	unsigned long num_bytes;
};

struct fikus_mem_p1275 {
	struct fikus_mlist_p1275 **p1275_totphys;
	struct fikus_mlist_p1275 **p1275_prommap;
	struct fikus_mlist_p1275 **p1275_available; /* What we can use */
};
