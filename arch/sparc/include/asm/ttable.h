...
#ifdef CONFIG_COMPAT
#define	FIKUS_32BIT_SYSCALL_TRAP SYSCALL_TRAP(fikus_sparc_syscall32, sys_call_table32)
#else
#define	FIKUS_32BIT_SYSCALL_TRAP BTRAP(0x110)
#endif
#define FIKUS_64BIT_SYSCALL_TRAP SYSCALL_TRAP(fikus_sparc_syscall, sys_call_table64)
