/*
 * kdebug.h:  Defines and definitions for debugging the Fikus kernel
...
extern struct kernel_debug *fikus_dbvec;
...
static inline void sp_enter_debugger(void)
{
	__asm__ __volatile__("jmpl %0, %%o7\n\t"
			     "nop\n\t" : :
			     "r" (fikus_dbvec) : "o7", "memory");
}

#define SP_ENTER_DEBUGGER do { \
	     if((fikus_dbvec!=0) && ((*(short *)fikus_dbvec)!=-1)) \
	       sp_enter_debugger(); \
		       } while(0)
