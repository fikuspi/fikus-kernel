...
/* Note that all the ioctls that are not available in Fikus have a 
 * double underscore on the front to: a) avoid some programs to
 * think we support some ioctls under Fikus (autoconfiguration stuff)
 */
/* Little t */
...
/* Fikus specific, no SunOS equivalent. */
#define TIOCFIKUS	0x541C
