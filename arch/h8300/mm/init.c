 ...
 *  Based on:
 *
 *  fikus/arch/m68knommu/mm/init.c
 *  fikus/arch/m68k/mm/init.c
 *
 *  Copyright (C) 1995  Hamish Macdonald
 *
 *  JAN/1999 -- hacked to support ColdFire (gerg@snapgear.com)
 *  DEC/2000 -- fikus 2.4 support <davidm@snapgear.com>
 */
...
/*
 * BAD_PAGE is the page that is used for page faults when fikus
 * is out-of-memory. Older versions of fikus just did a
