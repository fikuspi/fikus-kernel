/*
 * fikus/include/asm-sh/microdev.h
 *
...
/*
 * The following are the IRQ numbers for the Fikus Kernel for external
 * interrupts.  i.e. the numbers seen by 'cat /proc/interrupt'.
 */
#define MICRODEV_FIKUS_IRQ_KEYBOARD	 1	/* SuperIO Keyboard */
#define MICRODEV_FIKUS_IRQ_SERIAL1	 2	/* SuperIO Serial #1 */
#define MICRODEV_FIKUS_IRQ_ETHERNET	 3	/* on-board Ethnernet */
#define MICRODEV_FIKUS_IRQ_SERIAL2	 4	/* SuperIO Serial #2 */
#define MICRODEV_FIKUS_IRQ_USB_HC	 7	/* on-board USB HC */
#define MICRODEV_FIKUS_IRQ_MOUSE	12	/* SuperIO PS/2 Mouse */
#define MICRODEV_FIKUS_IRQ_IDE2		13	/* SuperIO IDE #2 */
#define MICRODEV_FIKUS_IRQ_IDE1		14	/* SuperIO IDE #1 */
