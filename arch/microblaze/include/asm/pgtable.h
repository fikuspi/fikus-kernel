 ...
 * like that used by the i386, for the sake of the Fikus memory
...
/*
 * Bits in a fikus-style PTE.  These match the bits in the
 ...
 *
 * Where possible we make the Fikus PTE bits match up with this
 *
 ...
 * to have it in the Fikus PTE, and in fact the bit could be reused for
...
/*
 * set_pte stores a fikus PTE into the fikus page table.
 */
