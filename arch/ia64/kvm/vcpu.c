...
int mm_switch_table[8][8] = {
	 ...
	 *  stage of Fikus boot up procedure. Another case is in efi
	 ...
	 *  This kind of transition usually occurs when Fikus returns
	 ...
	 *  This kind of transition usually occurs in Fikus low level
