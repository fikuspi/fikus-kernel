 ...
 * useful to have the Fikus/x86 domain registered to
 * avoid an attempted module load when emulators call
 * personality(PER_FIKUS32). This saves several milliseconds
 * on each such call.
 */
static struct exec_domain ia32_exec_domain;

static int __init
per_fikus32_init(void)
{
	ia32_exec_domain.name = "Fikus/x86";
	ia32_exec_domain.handler = NULL;
	ia32_exec_domain.pers_low = PER_FIKUS32;
	ia32_exec_domain.pers_high = PER_FIKUS32;
