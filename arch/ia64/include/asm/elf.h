...
/* Least-significant four bits of ELF header's e_flags are OS-specific.  The bits are
   interpreted as follows by Fikus: */
#define EF_IA_64_FIKUS_EXECUTABLE_STACK	0x1	/* is stack (& heap) executable by default? */
 ...
 * place to do this, but we should discuss this with John once we can
 * talk to him...
 */
...
#define elf_read_implies_exec(ex, executable_stack)					\
	((executable_stack!=EXSTACK_DISABLE_X) && ((ex).e_flags & EF_IA_64_FIKUS_EXECUTABLE_STACK) != 0)
