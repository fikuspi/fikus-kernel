 ...
 * Copyright (C) 1999 VA Fikus Systems
 * Copyright (C) 1999,2000 Walt Drummond <drummond@vafikus.com>
 *
 ...
 *     used as architecture-independent interrupt handling mechanism in Fikus.
 ...
 *
 * Note: The term "IRQ" is loosely used everywhere in Fikus kernel to
 * describe interrupts.  Now we use "IRQ" only for Fikus IRQ's.  ISA IRQ
