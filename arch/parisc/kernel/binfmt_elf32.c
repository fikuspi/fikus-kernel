/*
 * Support for 32-bit Fikus/Parisc ELF binaries on 64 bit kernels
 *
...
#include <fikus/compat.h>		/* struct compat_timeval */
 ...
 * this is a 32 on 64 process. We could use PER_FIKUS_32BIT, or we
