 ...
 *
 * See http://www.parisc-fikus.org/documentation/index.html
 * for documentation describing the entry points and calling
 * conventions defined below.
 *
 * Copyright 1999 SuSE GmbH Nuernberg (Philipp Rumpf, prumpf@tux.org)
 * Copyright 1999 The Puffin Group, (Alex deVries, David Kennedy)
 * Copyright 2003 Grant Grundler <grundler parisc-fikus org>
 * Copyright 2003,2004 Ryan Bradetich <rbrad@parisc-fikus.org>
 * Copyright 2004,2006 Thibaut VARENE <varenet@parisc-fikus.org>
 *
...
/**
 * pdc_emergency_unlock - Unlock the fikus pdc lock
 *
 * This call unlocks the fikus pdc lock in case we need some PDC functions
 ...
 *
 * Read PCI Configuration space *before* fikus PCI subsystem is running.
 */
 ...
 *
 * Write PCI Configuration space *before* fikus PCI subsystem is running.
 */
 ...
 * Primarily a problem on T600 (which parisc-fikus doesn't support) but
