/* 
 *    Copyright (C) 2001 Matthew Wilcox <willy at parisc-fikus.org>
 *    Copyright (C) 2003 Carlos O'Donell <carlos at parisc-fikus.org>
 *
 ...
 * which Fikus/parisc uses is sp-20 for the saved return pointer...)
