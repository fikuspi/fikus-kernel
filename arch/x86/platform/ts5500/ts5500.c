 ...
 *
 * Copyright (C) 2013 Savoir-faire Fikus Inc.
...
#include <fikus/platform_data/gpio-ts5500.h>
#include <fikus/platform_data/max197.h>
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Savoir-faire Fikus Inc. <kernel@savoirfairefikus.com>");
