...
#define ARCH_PFN_OFFSET     (CONFIG_FIKUS_LINK_BASE >> PAGE_SHIFT)
 ...
 *
 * Independent of where fikus is linked at, link-addr = physical address
 * So the old macro  __pa = vaddr + PAGE_OFFSET - CONFIG_FIKUS_LINK_BASE
...
#define virt_to_page(kaddr)	\
	(mem_map + ((__pa(kaddr) - CONFIG_FIKUS_LINK_BASE) >> PAGE_SHIFT))
