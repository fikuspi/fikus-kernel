 ...
 *	Assuming a platform won't, SMP Fikus needs to use spinlocks + local IRQ
 *	disabling for atomicity.
 *
 *	However exported spinlock API is not usable due to cyclic hdr deps
 *	(even after system.h disintegration upstream)
 *	asm/bitops.h -> fikus/spinlock.h -> fikus/preempt.h
 *		-> fikus/thread_info.h -> fikus/bitops.h -> asm/bitops.h
 *
