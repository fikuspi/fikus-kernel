/* -*- fikus-c -*-
 * fikus/arch/blackfin/kernel/ipipe.c
 *
...
asmlinkage int __ipipe_syscall_root(struct pt_regs *regs)
{
	 ...
	 * 0 -- if the syscall is to be passed to Fikus;
	 * >0 -- if the syscall should not be passed to Fikus, and no
	 * tail work should be performed;
	 * <0 -- if the syscall should not be passed to Fikus but the
	 ...
	 * safely assume a valid Fikus task stack here.
	 */
...
void __ipipe_disable_root_irqs_hw(void)
{
	 ...
	 * rates for Fikus without inducing pathological jitter for
