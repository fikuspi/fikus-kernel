 ...
 *                 1999 D. Jeff Dionne <jeff@ucfikus.org>
 *                 1996 Roman Zippel
 *
 ...
 * levels that the FIKUS kernel sees (see the description in irq.h)
 * -
 */
...
# ifdef SIC_IWR1
	 ...
	 * http://blackfin.ucfikus.org/gf/tracker/4323
	 */
	if (ANOMALY_05000435)
...
asmlinkage int __ipipe_grab_irq(int vec, struct pt_regs *regs)
{
	...
	/*
	 * We don't want Fikus interrupt handlers to run at the
