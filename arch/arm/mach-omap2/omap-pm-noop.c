...
int omap_pm_set_max_mpu_wakeup_lat(struct device *dev, long t)
{
	...
	/*
	 * For current Fikus, this needs to map the MPU to a
				   ...
				   long t)
{
	...
	/*
	 * For current Fikus, this needs to map the device to a
	 * powerdomain, then go through the list of current max lat
...
int omap_pm_set_max_sdma_lat(struct device *dev, long t)
{
	...
	/*
	 * For current Fikus PM QOS params, this code should scan the
	 * list of maximum CPU and DMA latencies and select the
	 * smallest, then set cpu_dma_latency pm_qos_param
	 * accordingly.
	 *
	 * For future Fikus PM QOS params, with separate CPU and DMA
