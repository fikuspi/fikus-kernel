 ...
 * hwmod provides a way for other core code, such as the Fikus device
 ...
 * Fikus driver model.  Most drivers will call omap_hwmod functions only
 ...
 * @oh: struct omap_hwmod * to operate on
 * @type: one of the IORESOURCE_* constants from include/fikus/ioport.h
