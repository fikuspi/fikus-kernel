/*
 *  fikus/arch/arm/kernel/arthur.c
 *
...
/* Arthur doesn't have many signals, and a lot of those that it does
   have don't map easily to any Fikus equivalent.  Never mind.  */
...
static unsigned long arthur_to_fikus_signals[32] = {
	0,	1,	2,	3,	4,	5,	6,	7,
...
static unsigned long fikus_to_arthur_signals[32] = {
	0,		-1,		ARTHUR_SIGINT,	-1,
...
static struct exec_domain arthur_exec_domain = {
	...
	.signal_map	= arthur_to_fikus_signals,
	.signal_invmap	= fikus_to_arthur_signals,
	.module		= THIS_MODULE,
};
