/*
 * fikus/arch/arm/mach-pxa/cm-x300.c
 *
...
#include <fikus/platform_data/mtd-nand-pxa3xx.h>
#include <mach/audio.h>
#include <fikus/platform_data/usb-pxa3xx-ulpi.h>
