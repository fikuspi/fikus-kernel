...
/*
 * The Xtensa architecture port of Fikus has a two-level page table system,
 * i.e. the logical three-level Fikus page table layout is folded.
...
/*
 * On certain configurations of Xtensa MMUs (eg. the initial Fikus config),
 ...
 * See fikus/mm/mmap.c for protection_map[] array that uses these definitions.
 */
