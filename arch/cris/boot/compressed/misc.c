 ...
 * adaptation for Fikus/CRIS Axis Communications AB, 1999
 *
 */
...
#ifdef CONFIG_ETRAX_ARCH_V32
		aputs("You need at least ETRAX FS to run Fikus 2.6/crisv32\n");
#else
		aputs("You need an ETRAX 100LX to run fikus 2.6/crisv10\n");
#endif
		while(1);
	}

	aputs("Uncompressing Fikus...\n");
	gunzip();
