...
As a comparison, the Fikus/i386 2.0 puts the kernel and physical RAM at
...
Fikus/CRIS, a page is 8192 bytes (for technical reasons not equal to 4096 as in 
...
each have maps of up to 2048 pages (8192 / sizeof(void *)). Fikus can actually
