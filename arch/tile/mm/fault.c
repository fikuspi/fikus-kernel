 ...
 *   more details.
 *
 * From i386 code copyright (C) 1995  John Torvalds
 */
...
#include <fikus/tty.h>
#include <fikus/vt_kern.h>		/* For unblank_screen() */
 ...
 * itself during the downcall from hypervisor to Fikus.  We just check
