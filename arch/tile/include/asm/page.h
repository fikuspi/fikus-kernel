 ...
 * the respective sizes of the two page types.  See <fikus/mmzone.h>.
 */
 ...
 *
 * The top 16MB chunk in the table below is unavailable to Fikus.  Since
...
{
	extern void *high_memory;  /* copied from <fikus/mm.h> */
