...
struct pci_controller {
	...
	/*
	 * Mem-Map regions for all the memory controllers so that Fikus can
	...
	/* Table that maps the INTx numbers to Fikus irq numbers. */
 ...
 * in case we don't have a BIOS and we want to let Fikus do it.
 */
