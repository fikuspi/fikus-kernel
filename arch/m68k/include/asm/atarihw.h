/*
** fikus/atarihw.h -- This header defines some macros and pointers for
...
#ifndef _FIKUS_ATARIHW_H_
#define _FIKUS_ATARIHW_H_
...
** for description see File 'fikus\tools\atari\hardware.txt
 */
