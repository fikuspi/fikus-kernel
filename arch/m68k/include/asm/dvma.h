...
/* Fikus DMA information structure, filled during probe. */
struct Fikus_SBus_DMA {
	struct Fikus_SBus_DMA *next;
	struct fikus_sbus_device *SBus_dev;
...
extern struct Fikus_SBus_DMA *dma_chain;
