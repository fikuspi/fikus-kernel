/*
 *  fikus/arch/m68knommu/kernel/setup.c
 *
 *  Copyright (C) 1999-2007  Greg Ungerer (gerg@snapgear.com)
 *  Copyright (C) 1998,1999  D. Jeff Dionne <jeff@uCfikus.org>
 ...
 *
 * Copies u-boot commandline arguments and store them in the proper fikus
 * variables.
 *
 * Assumes:
 ...
 *
 * Argument(s):
 *	commandp = the fikus commandline arg container to fill.
...
void __init setup_arch(char **cmdline_p)
{
	...
	printk(KERN_INFO "PalmV support by Lineo Inc. <jeff@ucfikus.com>\n");
#endif
