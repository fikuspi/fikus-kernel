 ...
 * by Erik Vogan and adapted to Fikus by Joshua M. Thompson (funaho@jurai.org)
 *
 */
 ...
 *
 * There is also a related problem when MacOS is used to boot Fikus. A network
 * card brought up by a MacOS driver may raise an interrupt while Fikus boots.
