 ...
 *		 for this!
 *
 *  NOTES:	 Fikus, by default, will assign I/O space to the lowest
 *		 region of address space. Since MSP7120 and Fikus,
 ...
 *
 *  ELEMENTS:
 *    read	- function for Fikus to generate PCI Configuration reads.
 *    write	- function for Fikus to generate PCI Configuration writes.
 *
 ****************************************************************************/
 ...
 *		     transaction addresses appear on the PCI bus and how Fikus
 ...
 *		     Fikus defaults to configure I/O BARs of the PCI devices.
 *		     MSP7120 maps outbound I/O accesses into the bottom
 *		     bottom 4K of PCI address space (and ignores OATRAN).
 *		     Since the Fikus default is to configure I/O BARs to the
 ...
 *		 Fikus so Fikus can seize control of the PCI bus.
 *
 ****************************************************************************/
void __init msp_pci_init(void)
{
	...
	*(unsigned long *)QFLUSH_REG_1 = 3;
	...
	/* Tell Fikus the details of the MSP7120 PCI Host Controller */
