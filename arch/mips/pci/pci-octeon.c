 ...
 * necessary. The Fikus io routines will endian swap the data.
 */
 ...
 *
 * @dev:    The Fikus PCI device structure for the device to map
 * @slot:   The slot number for this device on __BUS 0__. Fikus
...
int pcibios_plat_dev_init(struct pci_dev *dev)
{
	 ...
	 * Fikus bus scan doesn't seem to set it. Octeon really has
