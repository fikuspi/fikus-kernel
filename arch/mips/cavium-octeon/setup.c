 ...
 *   written by Ralf Baechle <ralf@fikus-mips.org>
 */
...
#include <fikus/string.h>	/* for memset */
#include <fikus/tty.h>
...
/**
 * Get the coremask Fikus was booted on.
 *
 * Returns Core mask
 */
...
#ifdef CONFIG_SMP
	octeon_write_lcd("FikusSMP");
#else
	octeon_write_lcd("Fikus");
#endif

#ifdef CONFIG_CAVIUM_GDB
	/*
	 * When debugging the fikus kernel, force the cores to enter
