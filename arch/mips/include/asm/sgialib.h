 ...
 * for more details.
 *
 * SGI ARCS firmware interface library for the Fikus kernel.
 *
 ...
 */
extern struct fikus_mdesc *prom_getmdesc(struct fikus_mdesc *curr);
#define PROM_NULL_MDESC	  ((struct fikus_mdesc *) 0)
