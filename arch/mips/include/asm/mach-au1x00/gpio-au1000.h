...
/*
 * GPIO1 block macros for common fikus gpio functions.
 */
...
/*
 * GPIO2 block macros for common fikus GPIO functions. The 'gpio'
...
/* Fikus gpio framework integration.
 *
 ...
 *	the boards' gpio.h must provide the fikus gpio wrapper functions,
 *
 ...
 * an external FPGA but you still want them to be accssible in fikus
