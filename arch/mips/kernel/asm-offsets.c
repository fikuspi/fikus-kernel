...
void output_mm_defines(void)
{
	...
	BLANK();
	COMMENT("Fikus mm_struct offsets.");
...
{
	COMMENT("Fikus sigcontext offsets.");
...
{
	COMMENT("Fikus 32-bit sigcontext offsets.");
...
{
	COMMENT(" Fikus struct pbe offsets. ");
