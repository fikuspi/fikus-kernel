...
int hash_page(unsigned long ea, unsigned long access, unsigned long trap)
{
	...
	ptep = find_fikus_pte_or_hugepte(pgdir, ea, &hugeshift);
		  ...
		  unsigned long access, unsigned long trap)
{
	...
	if (!vsid)
		return;
	/*
	 * Hash doesn't like irqs. Walking fikus page table with irq disabled
	 ...
	 */
	ptep = find_fikus_pte_or_hugepte(pgdir, ea, &hugepage_shift);
	if (!ptep)
		goto out_exit;
