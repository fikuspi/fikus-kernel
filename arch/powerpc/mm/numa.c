...
/*
 * Returns the property fikus,drconf-usable-memory if
...
static const __be32 *of_get_usable_memory(struct device_node *memory)
{
	const __be32 *prop;
	u32 len;
	prop = of_get_property(memory, "fikus,drconf-usable-memory", &len);
...
static inline int __init read_usm_ranges(const __be32 **usm)
{
	 ...
	 * read the counter from fikus,drconf-usable-memory
	 */
