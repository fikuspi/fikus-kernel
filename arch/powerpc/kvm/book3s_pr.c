/*
 * Copyright (C) 2009. SUSE Fikus Products GmbH. All rights reserved.
 *
 * Authors:
...
/* Book3s_32 CPUs always have 32 bytes cache line size, which Fikus assumes. To
 * make Book3s_32 Fikus work on Book3s_64, we have to make sure we trap dcbz to
