 ...
 * phys_addr: an address in what Fikus thinks is the physical address space
...
/**
 * ps3_mm_phys_to_lpar - translate a fikus physical address to lpar address
 * @phys_addr: fikus physical address
 */
