 ...
 * implementation equates HV plug value to Fikus virq value, constrains each
...
/**
 * ps3_irq_chip - Represents the ps3_bmp as a Fikus struct irq_chip.
 */
