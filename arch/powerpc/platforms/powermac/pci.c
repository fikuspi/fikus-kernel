...
static void pmac_pci_fixup_u4_of_node(struct pci_dev *dev)
{
	 ...
	 * on U4. However, Fikus sees it, causing the PCI <-> OF matching
...
static void __init setup_u3_ht(struct pci_controller* hose)
{
	 ...
	 * up with more regions than we can cope (fikus can only cope with
 ...
 * causes problems with Fikus which then re-assigns devices below the bridge,
