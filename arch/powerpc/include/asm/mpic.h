...
/* Allocate the controller structure and setup the fikus irq descs
 ...
 * that is senses[0] correspond to fikus irq "irq_offset".
 */
 ...
 * IPI number is then the offset'ed (fikus irq number mapped to the IPI)
 */
