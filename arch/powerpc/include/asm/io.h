 ...
 * fikus PCI accessors. Unlike those, they take the address first and the value
 * next.
 *
 ...
 *
 * Those are globally defined fikus accessors for devices on PCI or ISA
 * busses. They follow the Fikus defined semantics. The current implementation
