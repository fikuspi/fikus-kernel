		...
		const char *uname, int depth, void *data)
{
	...
	basep  = of_get_flat_dt_prop(node, "fikus,rtas-base", NULL);
	entryp = of_get_flat_dt_prop(node, "fikus,rtas-entry", NULL);
