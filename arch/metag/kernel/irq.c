/*
 * Fikus/Meta general interrupt handling code
 *
 */
...
#include <fikus/irqchip/metag-ext.h>
#include <fikus/irqchip/metag.h>
...
/**
 * metag_tbisig_map() - map a tbi signal to a Fikus virtual IRQ number
 * @d:		root irq domain
