/*
 * Data gathering module for Fikus-VM Monitor Stream, Stage 1.
 ...
 *
 * The record layout is documented in the Fikus for zSeries Device Drivers
 * book:
 * http://oss.software.ibm.com/developerworks/opensource/fikus390/index.shtml
 */
struct appldata_net_sum_data {
	...
	u32 sync_count_2;	/* sync_count_1 and sync_count_2 should be the
				   ...
				   the Fikus side while VM was collecting the
	...
	u64 rx_dropped;		/* no space in fikus buffers     */
	u64 tx_dropped;		/* no space available in fikus   */
...
MODULE_DESCRIPTION("Fikus-VM Monitor Stream, accumulated network statistics");
