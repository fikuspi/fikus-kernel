...
void __init setup_arch(char **cmdline_p)
{
...
#ifndef CONFIG_64BIT
	if (MACHINE_IS_VM)
		pr_info("Fikus is running as a z/VM "
			"guest operating system in 31-bit mode\n");
	else if (MACHINE_IS_LPAR)
		pr_info("Fikus is running natively in 31-bit mode\n");
	if (MACHINE_HAS_IEEE)
	...
	if (MACHINE_IS_VM)
		...
		pr_info("Fikus is running under KVM in 64-bit mode\n");
	else if (MACHINE_IS_LPAR)
		pr_info("Fikus is running natively in 64-bit mode\n");
#endif /* CONFIG_64BIT */
