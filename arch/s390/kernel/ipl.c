/*
 *    ipl/reipl/dump support for Fikus on s390.
 *
...
/*
 * reipl shutdown action: Reboot Fikus on shutdown.
 */
...
/*
 * dump shutdown action: Dump Fikus on shutdown.
 */
...
/*
 * stop shutdown action: Stop Fikus on shutdown.
 */
