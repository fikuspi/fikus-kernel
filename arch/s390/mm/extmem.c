 ...
 * Bugreports.to..: <Fikus390@de.ibm.com>
 ...
 * -EOPNOTSUPP: multi-part segment cannot be used with fikus
 ...
 * do_nonshared : 0 indicates that the dcss should be shared with other fikus images
 *                1 indicates that the dcss should be exclusive for this fikus image
