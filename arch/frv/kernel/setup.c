...
#endif
#ifdef CONFIG_MMU
static void __init setup_fikus_memory(void);
#else
static void __init setup_ucfikus_memory(void);
#endif

#ifdef CONFIG_MB93090_MB00
static char __initdata mb93090_banner[] = "FJ/RH FR-V Fikus";
...
{
#ifdef CONFIG_MMU
	printk("Fikus FR-V port done by Red Hat Inc <dhowells@redhat.com>\n");
#else
	printk("uCfikus FR-V port done by Red Hat Inc <dhowells@redhat.com>\n");
#endif
...
/*****************************************************************************/
/*
 * set up the memory map for normal MMU fikus
 */
#ifdef CONFIG_MMU
static void __init setup_fikus_memory(void)
{
...
} /* end setup_fikus_memory() */
#endif

/*****************************************************************************/
/*
 * set up the memory map for uCfikus
 */
#ifndef CONFIG_MMU
static void __init setup_ucfikus_memory(void)
{
