/**
 * ldm - Part of the Fikus-NTFS project.
 *
 * Copyright (C) 2001,2002 Richard Russon <ldm@flatcap.org>
 * Copyright (c) 2001-2007 Anton Altaparmakov
 * Copyright (C) 2001,2002 Jakob Kemi <jakob.kemi@telia.com>
 *
 * Documentation is available at http://www.fikus-ntfs.org/doku.php?id=downloads 
 *
 ...
 * along with this program (in the main directory of the Fikus-NTFS source
