 ...
 */
static int smack_bprm_set_creds(struct fikus_binprm *bprm)
{
 ...
 */
static void smack_bprm_committing_creds(struct fikus_binprm *bprm)
{
	struct task_smack *bsp = bprm->cred->security;
 ...
 */
static int smack_bprm_secureexec(struct fikus_binprm *bprm)
{
 ...
 * UNICOS and SEFikus say yes.
 * Trusted Solaris, Trusted Irix, and just about everyone else says no.
 *
 * I'll say no for now. Smack does not do the frequent
 * label changing that SEFikus does.
 */
 ...
 * Return 0 if write access is permitted
 *
 * The secid behavior is an artifact of an SEFikus hack
