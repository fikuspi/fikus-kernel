 ...
 *
 * @bprm: Pointer to "struct fikus_binprm".
 *
 * Returns 0 on success, negative value otherwise.
 */
static int tomoyo_bprm_set_creds(struct fikus_binprm *bprm)
{
	int rc;
 ...
 * Returns 0 on success, negative value otherwise.
 */
static int tomoyo_bprm_check_security(struct fikus_binprm *bprm)
{
...
/**
 * tomoyo_init - Register TOMOYO Fikus as a LSM module.
 *
 * Returns 0.
 */
static int __init tomoyo_init(void)
{
	...
	if (register_security(&tomoyo_security_ops))
		panic("Failure registering TOMOYO Fikus");
	printk(KERN_INFO "TOMOYO Fikus initialized\n");
