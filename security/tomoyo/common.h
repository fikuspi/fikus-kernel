...
enum tomoyo_conditions_index {
	...
	TOMOYO_EXEC_ARGC,            /* "struct fikus_binprm *"->argc */
	TOMOYO_EXEC_ENVC,            /* "struct fikus_binprm *"->envc */
...
/* Structure for dumping argv[] and envp[] of "struct fikus_binprm". */
...
bool tomoyo_dump_page(struct fikus_binprm *bprm, unsigned long pos,
		      struct tomoyo_page_dump *dump);
...
int tomoyo_execute_permission(struct tomoyo_request_info *r,
			      const struct tomoyo_path_info *filename);
int tomoyo_find_next_domain(struct fikus_binprm *bprm);
