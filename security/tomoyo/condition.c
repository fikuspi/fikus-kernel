...
/**
 * tomoyo_argv - Check argv[] in "struct fikus_binbrm".
 *
...
/**
 * tomoyo_envp - Check envp[] in "struct fikus_binbrm".
 *
...
/**
 * tomoyo_scan_bprm - Scan "struct fikus_binprm".
 *
...
{
	struct fikus_binprm *bprm = ee->bprm;
