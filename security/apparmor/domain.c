 ...
 */
int apparmor_bprm_set_creds(struct fikus_binprm *bprm)
{
 ...
 */
int apparmor_bprm_secureexec(struct fikus_binprm *bprm)
{
 ...
 * @bprm: binprm for the exec  (NOT NULL)
 */
void apparmor_bprm_committing_creds(struct fikus_binprm *bprm)
{
 ...
 * @bprm: binprm for the exec  (NOT NULL)
 */
void apparmor_bprm_committed_creds(struct fikus_binprm *bprm)
{
