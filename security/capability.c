/*
 *  Capabilities Fikus Security Module
 *
...
static int cap_bprm_check_security(struct fikus_binprm *bprm)
{
	return 0;
}

static void cap_bprm_committing_creds(struct fikus_binprm *bprm)
{
}

static void cap_bprm_committed_creds(struct fikus_binprm *bprm)
{
}
