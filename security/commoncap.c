...
#include <fikus/prctl.h>
#include <fikus/securebits.h>
 ...
 */
static inline void bprm_clear_caps(struct fikus_binprm *bprm)
{
 ...
 */
static int get_file_caps(struct fikus_binprm *bprm, bool *effective, bool *has_cap)
{
 ...
 */
int cap_bprm_set_creds(struct fikus_binprm *bprm)
{
 ...
 */
int cap_bprm_secureexec(struct fikus_binprm *bprm)
{
