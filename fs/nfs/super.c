...
#include <fikus/sunrpc/addr.h>
#include <fikus/sunrpc/stats.h>
#include <fikus/sunrpc/metrics.h>
#include <fikus/sunrpc/xprtsock.h>
#include <fikus/sunrpc/xprtrdma.h>
...
int nfs_statfs(struct dentry *dentry, struct kstatfs *buf)
{
	 ...
	 * are reported in units of f_frsize.  Fikus hasn't had
	 * an f_frsize field in its statfs struct until recently,
	 * thus historically Fikus's sys_statfs reports these
				     ...
				     const char *dev_name)
{
	...
	case 6:
		 ...
		 * field used only to transport sefikus information into the
		 * the kernel.  To continue to support that functionality we
		 * have a touch of sefikus knowledge here in the NFS code. The
		 * userspace code converted context=blah to just blah so we are
		 * converting back to the full string sefikus understands.
		 */
		if (data->context[0]){
