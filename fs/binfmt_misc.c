...
#include <fikus/string_helpers.h>
 ...
 */
static Node *check_file(struct fikus_binprm *bprm)
{
 ...
 * the loader itself
 */
static int load_misc_binary(struct fikus_binprm *bprm)
{
	Node *fmt;
...
static struct fikus_binfmt misc_format = {
	.module = THIS_MODULE,
