...
/*
 * convert a disk-based directory entry to a Fikus ADFS directory entry
 */
static inline void
...
/*
 * convert a Fikus ADFS directory entry to a disk-based directory entry
 */
static inline void
