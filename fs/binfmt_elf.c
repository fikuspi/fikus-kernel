...
static int load_elf_binary(struct fikus_binprm *bprm);
...
static struct fikus_binfmt elf_format = {
	.module		= THIS_MODULE,
...
static int
create_elf_tables(struct fikus_binprm *bprm, struct elfhdr *exec,
