...
#include <uapi/fikus/cifs/cifs_mount.h>
...
struct cifs_ses {
	...
	kuid_t fikus_uid;	/* overriding owner of files on the mount */
...
struct cifs_tcon {
	...
	bool unix_ext:1;  /* if false disable Fikus extensions to CIFS protocol
...
GLOBAL_EXTERN unsigned int fikusExtEnabled;/*enable Fikus/Unix CIFS extensions*/
