...
/* Convert ACL from CIFS POSIX wire format to local Fikus POSIX ACL xattr */
...
/* Convert ACL from local Fikus POSIX xattr to CIFS POSIX ACL wire format */
 ...
 *	same directory open on their desktop.  The Fikus cifs kernel
 *	client hooked into the kernel side of this interface for
 *	the same reason, but ironically when the VFS moved from
 *	"dnotify" to "inotify" it became harder to plug in Fikus
