...
#ifndef _FIKUS_HFS_FS_H
#define _FIKUS_HFS_FS_H
 ...
 *
 * The HFS-specific part of a Fikus (struct inode)
 */
struct hfs_inode_info {
	atomic_t opencnt;
 ...
 * struct hfs_sb_info
 *
 * The HFS-specific part of a Fikus (struct super_block)
 */
struct hfs_sb_info {
