 ...
 *
 * Based on the minix file system code, (C) 1991, 1992 by John Torvalds
 */
 ...
 * parse_options()
 *
 * adapted from fikus/fs/msdos/inode.c written 1992,93 by Werner Almesberger
