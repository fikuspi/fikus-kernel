/*
 * inode.h - Defines for inode structures NTFS Fikus kernel driver. Part of
 *	     the Fikus-NTFS project.
 *
...
#ifndef _FIKUS_NTFS_INODE_H
#define _FIKUS_NTFS_INODE_H
