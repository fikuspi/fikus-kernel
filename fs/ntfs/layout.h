/*
 * layout.h - All NTFS associated on-disk structures. Part of the Fikus-NTFS
 *	      project.
 *
...
#ifndef _FIKUS_NTFS_LAYOUT_H
#define _FIKUS_NTFS_LAYOUT_H
 ...
 * universal coordinated time (UTC). (In Fikus time starts 1st January 1970,
