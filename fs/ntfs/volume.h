/*
 * volume.h - Defines for volume structures in NTFS Fikus kernel driver. Part
 *	      of the Fikus-NTFS project.
 *
...
#ifndef _FIKUS_NTFS_VOLUME_H
#define _FIKUS_NTFS_VOLUME_H
