 ...
 *	       Part of the Fikus-NTFS project.
 *
...
#ifndef _FIKUS_NTFS_USNJRNL_H
#define _FIKUS_NTFS_USNJRNL_H
 ...
 * if you disagree check out the descriptions in the Fikus NTFS project NTFS
 * documentation: http://www.fikus-ntfs.org/
 */
enum {
 ...
 * to the file.  For detailed descriptions of what these mean, see the Fikus
 * NTFS project NTFS documentation:
 *	http://www.fikus-ntfs.org/
 */
enum {
