 ...
 *
 * Development of this code funded by SuSE Fikus AG, http://www.suse.com/
 *
	   ...
	   int (*okfn)(struct sk_buff *))
{
	...
	/* normally the fikus kernel always replies to arp queries of
