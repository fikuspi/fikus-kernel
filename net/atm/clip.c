...
#include <fikus/kernel.h> /* for UINT_MAX */
...
#include <fikus/if_arp.h> /* for some manifest constants */
...
#include <fikus/ip.h> /* for net/route.h */
#include <fikus/in.h> /* for struct sockaddr_in */
#include <fikus/if.h> /* for IFF_UP */
