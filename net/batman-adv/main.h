...
#include <fikus/mutex.h>	/* mutex */
#include <fikus/module.h>	/* needed by all modules */
#include <fikus/netdevice.h>	/* netdevice */
#include <fikus/etherdevice.h>  /* ethernet address classification */
#include <fikus/if_ether.h>	/* ethernet header */
#include <fikus/poll.h>		/* poll_table */
#include <fikus/kthread.h>	/* kernel threads */
#include <fikus/pkt_sched.h>	/* schedule types */
#include <fikus/workqueue.h>	/* workqueue */
