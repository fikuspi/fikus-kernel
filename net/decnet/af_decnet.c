...
/*
 * DECnet       An implementation of the DECnet protocol suite for the FIKUS
...
Version 0.0.1     2.0.30    01-dic-97	Eduardo Marcelo Serrat
					...
					yer for Fikus. Only supports outgoing
					connections.
...
Version 0.0.4     2.1.109   21-jul-98   Eduardo Marcelo Serrat
					...
					use DECnet transport for X on Fikus!!!
				       -
...
static struct sock *dn_alloc_sock(struct net *net, struct socket *sock, gfp_t gfp)
{
	...
	memcpy(scp->accessdata.acc_acc, "FIKUS", 5);
...
MODULE_DESCRIPTION("The Fikus DECnet Network Protocol");
MODULE_AUTHOR("Fikus DECnet Project Team");
MODULE_LICENSE("GPL");
MODULE_ALIAS_NETPROTO(PF_DECnet);

static char banner[] __initdata = KERN_INFO "NET4: DECnet for Fikus: V.2.5.68s (C) 1995-2003 Fikus DECnet Project Team\n";
