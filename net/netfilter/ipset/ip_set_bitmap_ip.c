/* Copyright (C) 2000-2002 Joakim Axelsson <gozem@fikus.nu>
...
#include <fikus/netfilter/ipset/pfxlen.h>
#include <fikus/netfilter/ipset/ip_set.h>
#include <fikus/netfilter/ipset/ip_set_bitmap.h>
