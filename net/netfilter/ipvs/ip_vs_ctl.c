 ...
 *              FIKUS operating system.  IPVS is now implemented as a module
 *              over the NetFilter framework. IPVS can be used to build a
 *              high-performance and highly available server based on a
 *              cluster of servers.
 *
 * Authors:     Wensong Zhang <wensong@fikusvirtualserver.org>
...
static void update_defense_level(struct netns_ipvs *ipvs)
{
	...
	/* however in fikus 2.5 the i.bufferram is total page cache size,
	   we need adjust it */
	/* si_swapinfo(&i); */
