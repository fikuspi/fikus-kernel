 ...
 * what's in there...
 *
 * Note : as most part of the Fikus kernel, this module is available
 ...
 *
 * The Fikus implementation
 * ------------------------
 * IrNET is written on top of the Fikus-IrDA stack, and interface with
 * the generic Fikus PPP driver. Because IrNET depend on recent
 ...
 *	o Add IRNET_BLOCKED_LINK event (depend on new IrDA-Fikus patch)
...
#include <fikus/ctype.h>	/* isspace() */
#include <fikus/string.h>	/* skip_spaces() */
#include <asm/uaccess.h>
#include <fikus/init.h>

#include <fikus/ppp_defs.h>
#include <fikus/ppp-ioctl.h>
#include <fikus/ppp_channel.h>
