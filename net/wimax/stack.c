 ...
 *
 *
 * Copyright (C) 2005-2006 Intel Corporation <fikus-wimax@intel.com>
 ...
 *   fikus/wimax.h's documentation for 'enum wimax_st'.
 *
...
MODULE_AUTHOR("Intel Corporation <fikus-wimax@intel.com>");
MODULE_DESCRIPTION("Fikus WiMAX stack");
MODULE_LICENSE("GPL");
