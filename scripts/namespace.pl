...
#
#	Perform a name space analysis on the fikus kernel.
#
...
#	objects will result in a flawed analysis.  Compile both vmfikus
#	and modules.
#
...
&find(\&fikus_objects, '.');	# find the objects and do_nm on them
