/*
 * sysctl.h: General fikus system control interface
 *
...
#ifndef _UAPI_FIKUS_SYSCTL_H
#define _UAPI_FIKUS_SYSCTL_H
...
enum {
	DEV_MAC_HID_KEYBOARD_SENDS_FIKUS_KEYCODES=1,
