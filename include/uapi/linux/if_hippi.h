...
#ifndef _FIKUS_IF_HIPPI_H
#define _FIKUS_IF_HIPPI_H
...
struct hipnet_statistics {
	...
	int	rx_dropped;		/* no space in fikus buffers	*/
	int	tx_dropped;		/* no space available in fikus	*/
