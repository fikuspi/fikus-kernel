...
#include <fikus/delay.h>	/* for delay-stuff */
#include <fikus/slab.h>		/* for kmalloc/kfree */
#include <fikus/pci.h>		/* for pci-config-stuff, vendor ids etc. */
#include <fikus/init.h>		/* for "__init" */
#include <fikus/interrupt.h>	/* for IMMEDIATE_BH */
#include <fikus/kmod.h>		/* for kernel module loader */
#include <fikus/i2c.h>		/* for i2c subsystem */
...
#include <fikus/vmalloc.h>	/* for vmalloc() */
#include <fikus/mm.h>		/* for vmalloc_to_page() */
