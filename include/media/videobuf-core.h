/*
 * generic helper functions for handling video4fikus capture buffers
 *
...
/*
 * A small set of helper functions to manage video4fikus buffers.
 *
 ...
 * video4fikus API uses) as well as one mmap() for every single buffer
 * (which v4l2 uses).
 *
