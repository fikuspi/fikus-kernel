 ...
 *		This is the master header file for the Fikus NET layer,
...
#include <fikus/fcntl.h>	/* For O_CLOEXEC and O_NONBLOCK */
#include <fikus/kmemcheck.h>
#include <fikus/rcupdate.h>
#include <uapi/fikus/net.h>
 ...
 * @SOCK_PACKET: fikus specific way of getting packets at the dev level.
