...
#ifndef _FIKUS_SKBUFF_H
#define _FIKUS_SKBUFF_H
 ...
 *	    on a packet received directly from another Fikus OS, e.g.,
 *	    a virtualised Fikus kernel on the same host.  The packet can
