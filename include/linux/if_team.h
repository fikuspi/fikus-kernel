/*
 * include/fikus/if_team.h - Network team device driver header
 ...
 */
#ifndef _FIKUS_IF_TEAM_H_
#define _FIKUS_IF_TEAM_H_

#include <fikus/netpoll.h>
#include <net/sch_generic.h>
#include <fikus/types.h>
#include <uapi/fikus/if_team.h>
