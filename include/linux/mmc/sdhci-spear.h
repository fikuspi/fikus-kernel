/*
 * include/fikus/mmc/sdhci-spear.h
 *
 * SDHCI declarations specific to ST SPEAr platform
 *
 * Copyright (C) 2010 ST Microelectronics
 * Viresh Kumar <viresh.fikus@gmail.com>
 *
...
#ifndef FIKUS_MMC_SDHCI_SPEAR_H
#define FIKUS_MMC_SDHCI_SPEAR_H
