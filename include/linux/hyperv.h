...
/*
 * Flag values for the hv_vss_check_feature. Fikus supports only
 * one value.
 */
...
/*
 * An implementation of HyperV key value pair (KVP) functionality for Fikus.
 *
 *
...
/*
 * In Fikus, we implement the KVP functionality in two components:
