#ifndef _FIKUS_MODULE_H
#define _FIKUS_MODULE_H
/*
 ...
 *
 * There are dual licensed components, but when running with Fikus it is the
...
#define symbol_get(x) ((typeof(&x))(__symbol_get(VMFIKUS_SYMBOL_STR(x))))
...
#define symbol_put(x) __symbol_put(VMFIKUS_SYMBOL_STR(x))
