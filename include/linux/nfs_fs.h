/*
 *  fikus/include/fikus/nfs_fs.h
 *
 *  Copyright (C) 1992  Rick Sladkey
 *
 *  OS-specific nfs filesystem definitions and declarations
 */
#ifndef _FIKUS_NFS_FS_H
#define _FIKUS_NFS_FS_H

#include <uapi/fikus/nfs_fs.h>
...
#include <fikus/nfs3.h>
#include <fikus/nfs4.h>
#include <fikus/nfs_xdr.h>
#include <fikus/nfs_fs_sb.h>
...
/*
 * fikus/fs/nfs/nfsroot.c
 */
extern int  nfs_root_data(char **root_device, char **root_data); /*__init*/
/* fikus/net/ipv4/ipconfig.c: trims ip addr off front of name, too. */
