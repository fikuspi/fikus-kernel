...
#include <fikus/workqueue.h>	/* work_struct */
#include <fikus/mempool.h>
#include <fikus/mutex.h>
#include <fikus/scatterlist.h>
#include <fikus/semaphore.h>	/* Needed for MUTEX init macros */
 ...
 *	a Fikus virtual address. The shared page frame is a linear block
