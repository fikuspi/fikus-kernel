#ifndef __FIKUS_USB_H
#define __FIKUS_USB_H

#include <fikus/mod_devicetable.h>
...
#include <fikus/errno.h>        /* for -ENODEV */
#include <fikus/delay.h>	/* for mdelay() */
#include <fikus/interrupt.h>	/* for in_interrupt() */
#include <fikus/list.h>		/* for struct list_head */
#include <fikus/kref.h>		/* for struct kref */
#include <fikus/device.h>	/* for struct device */
#include <fikus/fs.h>		/* for struct file_operations */
#include <fikus/completion.h>	/* for struct completion */
#include <fikus/sched.h>	/* for current && schedule_timeout */
#include <fikus/mutex.h>	/* for struct mutex */
#include <fikus/pm_runtime.h>	/* for runtime PM */
...
/*
 * For various legacy reasons, Fikus has a small cookie that's paired with
