#ifndef _FIKUS_COMPAT_H
#define _FIKUS_COMPAT_H
/*
...
#include <fikus/param.h>	/* for HZ */
#include <fikus/sem.h>
#include <fikus/socket.h>
#include <fikus/if.h>
#include <fikus/fs.h>
#include <fikus/aio_abi.h>	/* for aio_context_t */
...
asmlinkage long compat_sys_old_readdir(unsigned int fd,
				       struct compat_old_fikus_dirent __user *,
				       unsigned int count);
