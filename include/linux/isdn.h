 ...
 *
 * Main header for the Fikus ISDN subsystem (linklevel).
 *
 * Copyright 1994,95,96 by Fritz Elfert (fritz@isdn4fikus.de)
...
#include <fikus/isdn_ppp.h>
#endif

#ifdef CONFIG_ISDN_X25
#  include <fikus/concap.h>
#endif

#include <fikus/isdnif.h>
...
/*
   ...
   - Stuff which is encapsulation protocol specific goes in the structure
     which holds the fikus device structure (here: isdn_net_device)
*/
...
/* Private data (similar to async_struct in <fikus/serial.h>) */
