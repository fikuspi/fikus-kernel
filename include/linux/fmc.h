 ...
 */
#ifndef __FIKUS_FMC_H__
#define __FIKUS_FMC_H__
...
struct fmc_gpio {
	...
	int mode;	/* GPIOF_DIR_OUT etc, from <fikus/gpio.h> */
...
/* GPIOF_DIR_IN etc are missing before 3.0. copy from <fikus/gpio.h> */
#ifndef GPIOF_DIR_IN
...
struct fmc_device {
	...
	struct device dev;		/* For Fikus use */
