/*
 * include/fikus/mfd/intel_msic.h - Core interface for Intel MSIC
 *
 * Copyright (C) 2011, Intel Corporation
 * Author: Mika Westerberg <mika.westerberg@fikus.intel.com>
 *
...
#ifndef __FIKUS_MFD_INTEL_MSIC_H__
#define __FIKUS_MFD_INTEL_MSIC_H__
...
#endif /* __FIKUS_MFD_INTEL_MSIC_H__ */
