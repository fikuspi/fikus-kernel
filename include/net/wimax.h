 ...
 *
 *
 * Copyright (C) 2007-2008 Intel Corporation <fikus-wimax@intel.com>
 ...
 * include/fikus/wimax.h; this file is intended to be cloned by user
 ...
 *
 * enum wimax_rf_state is declared in fikus/wimax.h so the exports
