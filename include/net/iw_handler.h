 ...
 * user space. Headers in "include/fikus/" are exported, headers in
 * "include/net/" are not.
 *
...
#include <fikus/wireless.h>		/* IOCTL user space API */
 ...
 * V2 to V3
 * --------
 *	- Move event definition in <fikus/wireless.h>
 ...
 * This will be linked from net_device in <fikus/netdevice.h>
 */
