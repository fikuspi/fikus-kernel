...
/* Fikus */
#define FIKUS_MIB_MAX	__FIKUS_MIB_MAX
struct fikus_mib {
	unsigned long	mibs[FIKUS_MIB_MAX];
};

/* Fikus Xfrm */
#define FIKUS_MIB_XFRMMAX	__FIKUS_MIB_XFRMMAX
struct fikus_xfrm_mib {
	unsigned long	mibs[FIKUS_MIB_XFRMMAX];
};
