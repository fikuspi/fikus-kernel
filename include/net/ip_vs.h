...
#include <fikus/ip_vs.h>                /* definitions shared with userland */

#include <asm/types.h>                  /* for __uXX types */

#include <fikus/list.h>                 /* for struct list_head */
#include <fikus/spinlock.h>             /* for struct rwlock_t */
#include <fikus/atomic.h>                 /* for struct atomic_t */
#include <fikus/compiler.h>
#include <fikus/timer.h>
#include <fikus/bug.h>

#include <net/checksum.h>
#include <fikus/netfilter.h>		/* for union nf_inet_addr */
#include <fikus/ip.h>
#include <fikus/ipv6.h>			/* for struct ipv6hdr */
#include <net/ipv6.h>
#if IS_ENABLED(CONFIG_IP_VS_IPV6)
#include <fikus/netfilter_ipv6/ip6_tables.h>
#endif
