 ...
 * It is not a full fikus device in any way. It is only
 * a place to hang resources associated with a Fikus
 ...
 * See comments for translated Fikus codes returned by osd_req_decode_sense.
 */
