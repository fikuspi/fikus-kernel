/*
 * parse_vdso.c: Fikus reference vDSO parser
 * Written by Andrew Lutomirski, 2011.
 *
 * This code is meant to be linked in to various programs that run on Fikus.
 ...
 *
 *     <some pointer> = vdso_sym("FIKUS_2.6", "gettimeofday");
 * or
 *     <some pointer> = vdso_sym("FIKUS_2.6", "__vdso_gettimeofday");
 *
